...
import { a as i, l as a } from './theming-CIfRbxtV.js'
...
function l(...e) {
  return oe.useCallback(c(...e), e)
}
function u(e) {
  return M.isValidElement(e) && e.type === he
}
function d(e, t) {
  let n = { ...t }
  for (let r in t) {
...
function p(e, t) {
  return ue.useReducer((e, n) => t[e][n] ?? e, e)
}
function m(e) {
  let [t, n] = P.useState(),
    r = P.useRef({}),
  ...
  return (
    ...
    U(() => {
      if (t) {
        let e = (e) => {
            let n = h(r.current).includes(e.animationName)
            e.target === t && n && ce.flushSync(() => s(`ANIMATION_END`))
          },
          n = (e) => {
...
function g(e, t = []) {
  ...
  function r(t, r) {
    ...
    function o(t) {
      ...
      return (0, de.jsx)(s.Provider, { value: c, children: r })
    }
    function s(n, o) {
      let s = o?.[e][a] || i,
        c = F.useContext(s)
...
function x(e, t) {
  return fe.useReducer((e, n) => t[e][n] ?? e, e)
}
function S(e) {
...
var k,
  ...
  Ge = t(() => {
    ;((k = e(n(), 1)),
      ...
      (fe = e(n(), 1)),
      (R = r()),
      (pe = a.div(({ theme: e, $flexLayout: t = !1 }) => [
      ...
      (me = ({ actionItems: e, flexLayout: t = !1, ...n }) =>
        k.createElement(
          pe,
          { ...n, $flexLayout: t },
      ...
      (he = ({ children: e }) => (0, N.jsx)(N.Fragment, { children: e })),
      (H = [
        `a`,
        `button`,
        `div`,
      ...
      (U = globalThis?.document ? le.useLayoutEffect : () => {}),
      (W = (e) => {
...
`,
      ...
      (xe = j.forwardRef((e, t) => {
        ...
        return (
          ...
          i.type === `hover`
            ? (0, R.jsx)(Se, { ...r, ref: t, forceMount: n })
            : i.type === `scroll`
              ? (0, R.jsx)(Ce, { ...r, ref: t, forceMount: n })
              : i.type === `auto`
                ? (0, R.jsx)(we, { ...r, ref: t, forceMount: n })
                : i.type === `always`
                  ? (0, R.jsx)(X, { ...r, ref: t })
                  : null
        )
      ...
      (Se = j.forwardRef((e, t) => {
        ...
        return (
          ...
          (0, R.jsx)(W, {
            present: n || a,
            children: (0, R.jsx)(we, { 'data-state': a ? `visible` : `hidden`, ...r, ref: t }),
          })
        )
      })),
      (Ce = j.forwardRef((e, t) => {
      ...
      (we = j.forwardRef((e, t) => {
        ...
        return (
          ...
          (0, R.jsx)(W, {
            present: r || a,
            children: (0, R.jsx)(X, { 'data-state': a ? `visible` : `hidden`, ...i, ref: t }),
          })
        )
      })),
      (X = j.forwardRef((e, t) => {
      ...
      (ke = j.forwardRef((e, t) => {
        let {
          ...
          w = D(f, 10)
        function T(e) {
          _.current && u({ x: e.clientX - _.current.left, y: e.clientY - _.current.top })
        }
        return (
          j.useEffect(() => {
            let e = (e) => {
          ...
          (0, R.jsx)(De, {
            ...
            hasThumb: i,
            onThumbChange: v(a),
            onThumbPointerUp: v(o),
            onThumbPositionChange: C,
            onThumbPointerDown: v(s),
            children: (0, R.jsx)(H.div, {
              ...p,
              ref: g,
              ...
              onPointerDown: b(e.onPointerDown, (e) => {
                e.button === 0 &&
                  ...
                  (_.current = h.getBoundingClientRect()),
      ...
      (Ae = j.forwardRef((e, t) => {
        let { forceMount: n, ...r } = e,
          i = Oe(Z, e.__scopeScrollArea)
        return (0, R.jsx)(W, {
          present: n || i.hasThumb,
          children: (0, R.jsx)(je, { ref: t, ...r }),
        })
      })),
      (je = j.forwardRef((e, t) => {
        ...
        return (
          j.useEffect(() => {
            ...
            if (e) {
              let t = () => {
                ;(d(), !u.current && ((u.current = Pe(e, s)), s()))
              }
              return (
                s(),
      ...
      (Q = `ScrollAreaCorner`),
      (Me = j.forwardRef((e, t) => {
        let n = q(Q, e.__scopeScrollArea),
          r = !!(n.scrollbarX && n.scrollbarY)
        return n.type !== `scroll` && r ? (0, R.jsx)(Ne, { ...e, ref: t }) : null
      })),
      (Me.displayName = Q),
      (Ne = j.forwardRef((e, t) => {
      ...
      (Re = Ae),
      (ze = Me),
      (Be = a(Fe)(({ scrollbarsize: e, offset: t }) => ({
        width: `100%`,
        height: `100%`,
        overflow: `hidden`,
      ...
      (Ve = a(Ie)(({ focusable: e, theme: t }) => ({
        width: `100%`,
        height: `100%`,
        '&:focus': e ? { outline: `2px solid ${t.color.secondary}`, outlineOffset: -2 } : {},
      }))),
      (He = a(Le)(({ offset: e, horizontal: t, vertical: n }) => ({
        display: `flex`,
        userSelect: `none`,
        touchAction: `none`,
      ...
      (We = (0, A.forwardRef)(
        (
          ...
          A.createElement(
            ...
            t && n && A.createElement(ze, null)
          )
      )),
      (We.displayName = `ScrollArea`))
  })
function Ke(e, t = `assertive`, n = 7e3) {
  $
    ? $.announce(e, t, n)
    : (($ = new Je()),
...
export { We as a, me as i, qe as n, Ge as o, Ye as r, Ke as t }
