try {
  ...
  <defs>
    ...
    var Yl = __STORYBOOK_ICONS__,
      {
        ...
        ChevronSmallLeftIcon: Vi,
        ChevronSmallRightIcon: Yi,
        ChevronSmallUpIcon: ji,
        ChevronUpIcon: Wi,
        ChromaticIcon: zi,
        ChromeIcon: Ki,
        CircleHollowIcon: Xi,
        ...
        SideBySideIcon: Su,
        SidebarAltIcon: gu,
        SidebarAltToggleIcon: Eu,
        SidebarIcon: Iu,
        SidebarToggleIcon: vu,
        SortDownIcon: Au,
        SortUpIcon: xu,
        SpeakerIcon: $u,
        StackedIcon: _u,
    ...
    A()
    x()
    var ed = __STORYBOOK_CORE_EVENTS__,
      {
        AI_PROMPT_NUDGE: td,
        AI_SETUP_ANALYTICS_REQUEST: ad,
        AI_SETUP_ANALYTICS_RESPONSE: rd,
        ARGTYPES_INFO_REQUEST: nd,
        ARGTYPES_INFO_RESPONSE: od,
        CHANNEL_CREATED: ld,
        CHANNEL_WS_DISCONNECT: id,
        CONFIG_ERROR: sd,
        CREATE_NEW_STORYFILE_REQUEST: cd,
        CREATE_NEW_STORYFILE_RESPONSE: ud,
        CURRENT_STORY_WAS_SET: md,
        DOCS_PREPARED: dd,
        DOCS_RENDERED: pd,
        FILE_COMPONENT_SEARCH_REQUEST: fd,
        FILE_COMPONENT_SEARCH_RESPONSE: yd,
        FORCE_REMOUNT: bd,
        FORCE_RE_RENDER: hd,
        GHOST_STORIES_REQUEST: Sd,
        GHOST_STORIES_RESPONSE: gd,
        GLOBALS_UPDATED: Ed,
        MANAGER_INERT_ATTRIBUTE_CHANGED: Id,
        NAVIGATE_URL: vd,
        OPEN_IN_EDITOR_REQUEST: Ad,
        OPEN_IN_EDITOR_RESPONSE: xd,
        PLAY_FUNCTION_THREW_EXCEPTION: $d,
        PRELOAD_ENTRIES: _d,
        PREVIEW_BUILDER_PROGRESS: Td,
        PREVIEW_INITIALIZED: Rd,
        PREVIEW_KEYDOWN: Cd,
        REGISTER_SUBSCRIPTION: Od,
        REQUEST_WHATS_NEW_DATA: kd,
        RESET_STORY_ARGS: wd,
        RESULT_WHATS_NEW_DATA: Nd,
        SAVE_STORY_REQUEST: Pd,
        SAVE_STORY_RESPONSE: Dd,
        SELECT_STORY: Ld,
        SET_CONFIG: Md,
        ...
        SET_INDEX: Gd,
        SET_STORIES: Bd,
        SET_WHATS_NEW_CACHE: qd,
        SHARED_STATE_CHANGED: Vd,
        SHARED_STATE_SET: Yd,
        SHARE_ISOLATE_MODE: jd,
        SIDEBAR_FILTER_CHANGED: Wd,
        STORIES_COLLAPSE_ALL: zd,
    ...
    A()
    x()
    var kp = __REACT_DOM__,
      {
        __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: wp,
        createPortal: Np,
        createRoot: Pp,
        findDOMNode: Dp,
        flushSync: Dt,
        ...
        hydrateRoot: Mp,
        render: Fp,
        unmountComponentAtNode: Up,
        unstable_batchedUpdates: Hp,
        unstable_renderSubtreeIntoContainer: Gp,
        version: Bp,
      } = __REACT_DOM__
    K()
    K()
    ...
    var H = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      ...
      on = (e) => {
        ...
        let [T, C] = V(() => {
          ...
          ue = L(() => d?.[s.tab]?.every((m) => T.has(`${s.tab}.${m.id}`)) ?? !1, [d, T, s.tab]),
          Q = E((m, b, p) => {
            m.stopPropagation()
            let _ = `${b}.${p.id}`
        ...
        ;(O(() => {
          ...
          O(() => {
            if ((Y(Te, `${N}/selected`), Y(Te, `${N}/others`), !s.highlighted || nt)) return
    ...
    var We = w((e, t) => {
      ...
      if (i) {
        let o = i.props.children,
          u = l.map((c) =>
            c === i ? (U.count(o) > 1 ? U.only(null) : j(o) ? o.props.children : null) : c
          )
    ...
    function dn(e) {
      let t = e + 'CollectionProvider',
        ...
        o = (g) => {
          ...
          return n.createElement(l, { scope: h, itemMap: T, collectionRef: $ }, R)
        }
      ...
      function S(g) {
        ...
        return n.useCallback(() => {
          ...
          return Array.from(h.itemMap.values()).sort(
            (T, C) => $.indexOf(T.ref.current) - $.indexOf(C.ref.current)
          )
    ...
    var _n = w((e, t) => {
        let {
          ...
          S = Ce(t, f),
          g = Wt(i),
          [h = null, R] = jt({ prop: o, defaultProp: u, onChange: c }),
          [$, T] = V(!1),
          C = tt(s),
          ue = zt(a),
          Q = M(!1),
            ...
            y(
              ...
              P({ tabIndex: d ? 0 : -1, 'data-orientation': s.orientation }, o, {
                ...
                onKeyDown: X(e.onKeyDown, (h) => {
                  ...
                  let R = Cn(h, s.orientation, s.dir)
                  if (R !== void 0) {
                    h.preventDefault()
                    let $ = f()
                    ...
                    if (R === 'last') $.reverse()
                      ...
                      R === 'prev' && $.reverse()
                      let T = $.indexOf(h.currentTarget)
                      $ = s.loop ? On($, T + 1) : $.slice(T + 1)
                    }
                    setTimeout(() => Jt($))
                  }
                }),
    ...
    var ea = (e) => {
      let { present: t, children: a } = e,
        r = Pn(t),
        l = typeof a == 'function' ? a({ present: r.isPresent }) : U.only(a),
        i = Ce(r.ref, l.ref)
