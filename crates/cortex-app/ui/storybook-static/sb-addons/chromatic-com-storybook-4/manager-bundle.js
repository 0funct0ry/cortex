try {
  ;(() => {
    ...
    var Ue = { NODE_ENV: 'production', NODE_PATH: [], STORYBOOK: 'true', PUBLIC_URL: '.' }
    var a = __REACT__,
      {
        Children: g8,
        Component: Dt,
    ...
    var j8 = __STORYBOOK_TYPES__,
      {
        ...
        SupportedLanguage: G8,
        SupportedRenderer: Y8,
      } = __STORYBOOK_TYPES__
    var eg = __STORYBOOK_API__,
      {
        ActiveTabs: tg,
        Consumer: ng,
        ManagerContext: ag,
        Provider: rg,
        RequestResponseError: ig,
        Tag: lg,
        addons: dn,
        combineParameters: og,
        controlOrMetaKey: sg,
        controlOrMetaSymbol: dg,
        eventMatchesShortcut: cg,
        eventToShortcut: ug,
        experimental_MockUniversalStore: mg,
        experimental_UniversalStore: pg,
        experimental_getStatusStore: Pa,
        experimental_getTestProviderStore: ql,
        experimental_requestResponse: hg,
        experimental_useStatusStore: Gl,
        experimental_useTestProviderStore: Yl,
        experimental_useUniversalStore: fg,
        internal_checklistStore: gg,
        internal_fullStatusStore: vg,
        internal_fullTestProviderStore: yg,
        internal_universalChecklistStore: bg,
        internal_universalStatusStore: Eg,
        internal_universalTestProviderStore: kg,
        isMacLike: wg,
        isShortcutTaken: Cg,
        keyToSymbol: Sg,
        merge: xg,
        mockChannel: Ag,
        optionOrAltSymbol: Lg,
        shortcutMatchesShortcut: Fg,
        shortcutToAriaKeyshortcuts: Ng,
        shortcutToHumanString: Mg,
        types: Tg,
        useAddonState: Kl,
        useArgTypes: _g,
        useArgs: Ig,
    ...
    var Hg = __STORYBOOK_COMPONENTS__,
      {
        ...
        StatelessTab: A9,
        StatelessTabList: L9,
        StatelessTabPanel: F9,
        StatelessTabsView: N9,
        StorybookIcon: M9,
        StorybookLogo: T9,
        SyntaxHighlighter: _9,
        TT: I9,
        TabBar: O9,
        TabButton: Z9,
        TabList: R9,
        ...
        codeCommon: K9,
        components: J9,
        convertToReactAriaPlacement: Q9,
        createCopyToClipboardFunction: X9,
        getStoryHref: ev,
        interleaveSeparators: tv,
        nameSpaceClassNames: nv,
        resetComponents: av,
        useTabsState: rv,
        withReset: iv,
      } = __STORYBOOK_COMPONENTS__
    var cv = __STORYBOOK_THEMING__,
      {
        CacheProvider: uv,
        ClassNames: mv,
        Global: pv,
    ...
    function Rd(e, t = {}) {
      ...
      ;((function (v) {
        ...
        let E = ai('style')
        ;((E.dataset.neoconfetti = ''), (E.textContent = v), ri(document.head, E))
      })(Od),
        e.classList.add(Zd),
      ...
      function w(v, E) {
        let S = h(),
          L = y(o, S),
          F = (fe, ke) => v.style.setProperty(fe, ke + '')
        ;(F('--xlp', ii(Ha(So(E, 90) - 180), 0, 180, -u / 2, u / 2) + 'px'),
          F('--dc', r - Gn(1e3 * ot()) + 'ms'))
        let G = ot() < Pd ? mn(ot() * Vd, 2) : 0
        ;(F('--x1', G),
          F('--x2', -1 * G),
          F('--x3', G),
          F('--x4', mn(Ha(ii(Ha(So(E, 90) - 180), 0, 180, -1, 1)), 4)),
          F('--y1', mn(ot() * wo, 4)),
          F('--y2', mn(ot() * i * (Ao() ? 1 : -1), 4)),
          F('--y3', wo),
          F('--y4', mn(Hd(ii(Ha(E - 180), 0, 180, i, -i), 0), 4)),
          F('--w', (L ? s : Gn(4 * ot()) + s / 2) + 'px'),
          F('--h', (L ? s : Gn(2 * ot()) + s) + 'px'))
        let te = S.toString(2).padStart(3, '0').split('')
        ;(F('--hr', te.map((fe) => +fe / 2 + '').join(' ')),
          F('--r', te.join(' ')),
          F('--rd', mn(ot() * (Bd - ko) + ko) + 'ms'),
          F('--br', L ? '50%' : 0))
      }
      let b
      function g() {
        ;((e.innerHTML = ''),
          ...
          (f = (function (v, E = [], S) {
            ...
            for (let { color: F } of E) {
              let G = ai('div')
              ;((G.className = `${co} ${S}`), G.style.setProperty('--bgc', F))
              let te = ai('div')
          ...
          update(v) {
            ...
            if (E === l) {
              ...
              for (let [Le, { color: Vt }] of xo(p)) {
                let Ke = f[+Le]
                ;(JSON.stringify(n) !== JSON.stringify(G) && Ke.style.setProperty('--bgc', Vt),
                  S !== o && Ke.style.setProperty('--br', y(S, h()) ? '50%' : '0'),
                  F !== d && (d && Ke.classList.remove(d), F && Ke.classList.add(F)))
              }
            } else ye = !0
            ;(c && !Ae && clearTimeout(b),
    ...
    function oi(e) {
      ...
      return !e.includes('\x1B') && !e.includes('\x9B') ? e : e.replace(zd, '')
    }
    var Ud = Object.create,
      ...
      Rt = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
      Kd = (e, t) => {
      ...
      Jd = (e, t, n, r) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of Wd(t))
            !Gd.call(e, i) &&
              i !== n &&
              sl(e, i, { get: () => t[i], enumerable: !(r = $d(t, i)) || r.enumerable })
        return e
      },
      bt = (e, t, n) => (
        (n = e != null ? Ud(qd(e)) : {}),
        Jd(t || !e || !e.__esModule ? sl(n, 'default', { value: e, enumerable: !0 }) : n, e)
      ),
      dl = Rt((e, t) => {
        ;(function (n, r) {
          typeof Yd == 'function' && typeof e == 'object' && typeof t == 'object'
            ? (t.exports = r())
          ...
          function p(y, w, b) {
            return function (g) {
              var v = g.toLowerCase()
              return w.hasOwnProperty(v) ? d(g, v) : y.hasOwnProperty(v) ? d(g, y[v]) : u(v, g, b)
            }
          }
          function f(y, w, b, g) {
            return function (v) {
              var E = v.toLowerCase()
              return w.hasOwnProperty(E) ? !0 : y.hasOwnProperty(E) ? !1 : u(E, E, b) === E
            }
          }
          function h(y, w, b) {
        ...
        function o(c) {
          return function (m, u, p, f) {
            ...
            var h = l(),
              ...
              g = !1
            return (y === u ? f(n, m[c]) : requestAnimationFrame(E), v)
            function v() {
              g = !0
            }
            function E(S) {
      ...
      cl = Rt((e, t) => {
        ...
        function c(v, E) {
          return E.clone !== !1 && E.isMergeableObject(v) ? b(d(v), v, E) : v
        }
        function m(v, E, S) {
        ...
        function y(v, E) {
          return (
            h(v, E) && !(Object.hasOwnProperty.call(v, E) && Object.propertyIsEnumerable.call(v, E))
          )
        }
        function w(v, E, S) {
          var L = {}
          return (
            S.isMergeableObject(v) &&
              f(v).forEach(function (F) {
                L[F] = c(v[F], S)
              }),
            f(E).forEach(function (F) {
              y(v, F) ||
                (h(v, F) && S.isMergeableObject(E[F])
                  ? (L[F] = u(F, S)(v[F], E[F], S))
                  : (L[F] = c(E[F], S)))
            }),
            L
        ...
        function b(v, E, S) {
          ...
          var L = Array.isArray(E),
            F = Array.isArray(v),
            G = L === F
          return G ? (L ? S.arrayMerge(v, E, S) : w(v, E, S)) : c(E, S)
        }
        b.all = function (v, E) {
      ...
      Fo = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        C(
          'svg',
          {
            width: t,
      ...
      Jt = Y(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
        C(
          'svg',
          {
            width: t,
      ...
      Cs = $e(null),
      Jc = ({ children: e, value: t }) => a.createElement(Cs.Provider, { value: t }, e),
      gl = () => Et(Cs, 'AuthState'),
      Qc = {
      ...
      vl = ({ icon: e, ...t }) =>
        a.createElement(
          ...
          a.createElement(a.Fragment, null, Qc[e])
        )
    function Pe() {
      return (
        (Pe = Object.assign
    ...
    function g5(e, t, n) {
      if (typeof e == 'number' && typeof t == 'number' && typeof n == 'number') return sr(e, t, n)
    ...
    function v5(e, t, n, r) {
      if (
        ...
        return r >= 1 ? sr(e, t, n) : 'rgba(' + ua(e, t, n) + ',' + r + ')'
      if (typeof e == 'object' && t === void 0 && n === void 0 && r === void 0)
        return e.alpha >= 1
          ? sr(e.hue, e.saturation, e.lightness)
          : 'rgba(' + ua(e.hue, e.saturation, e.lightness) + ',' + e.alpha + ')'
      throw new ut(2)
    }
    function Zi(e, t, n) {
    ...
    function C5(e, t) {
      if (t === 'transparent') return t
      var n = Bt(t)
      return Pt(Pe({}, n, { lightness: Zn(0, 1, n.lightness - parseFloat(e)) }))
    }
    var S5 = He(C5),
      Ri = S5
    function x5(e, t) {
      if (t === 'transparent') return t
      var n = Bt(t)
      return Pt(Pe({}, n, { saturation: Zn(0, 1, n.saturation - parseFloat(e)) }))
    }
    He(x5)
    function A5(e, t) {
      if (t === 'transparent') return t
    ...
    function F5(e, t, n) {
      ...
      if (e === 0) return n
      var r = kn(t),
        i = Pe({}, r, { alpha: typeof r.alpha == 'number' ? r.alpha : 1 }),
        l = kn(n),
        o = Pe({}, l, { alpha: typeof l.alpha == 'number' ? l.alpha : 1 }),
        s = i.alpha - o.alpha,
        d = parseFloat(e) * 2 - 1,
        c = d * s === -1 ? d : d + s,
        m = 1 + d * s,
    ...
    function M5(e, t) {
      ...
      var n = kn(t),
        ...
        i = Pe({}, n, { alpha: Zn(0, 1, (r * 100 + parseFloat(e) * 100) / 100) })
      return wn(i)
    }
    He(M5)
    function T5(e, t) {
    ...
    He(T5)
    function _5(e, t) {
      return t === 'transparent' ? t : Pt(Pe({}, Bt(t), { hue: parseFloat(e) }))
    }
    He(_5)
    function I5(e, t) {
      return t === 'transparent' ? t : Pt(Pe({}, Bt(t), { lightness: parseFloat(e) }))
    }
    He(I5)
    function O5(e, t) {
      return t === 'transparent' ? t : Pt(Pe({}, Bt(t), { saturation: parseFloat(e) }))
    }
    He(O5)
    function Z5(e, t) {
    ...
    function B5(e, t) {
      ...
      var n = kn(t),
        r = typeof n.alpha == 'number' ? n.alpha : 1,
        i = Pe({}, n, { alpha: Zn(0, 1, +(r * 100 - parseFloat(e) * 100).toFixed(2) / 100) })
      return wn(i)
    }
    He(B5)
    var D = {
    ...
    var Fs = Mt({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(360deg)' } }),
      Ns = Mt({ '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } })
    Mt({
    ...
    var V5 = ce({
        animation: `${Ns} 1.5s ease-in-out infinite`,
        background: D.tr5,
        color: 'transparent',
        cursor: 'progress',
      }),
      ...
      D5 = k(vl)(
        {
          ...
          display: 'block',
          verticalAlign: 'top',
          path: { fill: D.medium, animation: `${Ns} 1.5s ease-in-out infinite` },
        },
        (e) => ({
      ...
      j5 = k.div(
        ...
        (e) =>
          ({
            tiny: { fontSize: `${H.size.s1 - 2}px`, lineHeight: `${Wt.tiny}px` },
            small: { fontSize: `${H.size.s1}px`, lineHeight: `${Wt.small}px` },
            medium: { fontSize: `${H.size.s2}px`, lineHeight: `${Wt.medium}px` },
            large: { fontSize: `${H.size.s3}px`, lineHeight: `${Wt.large}px` },
          })[e.size || 'medium']
      ),
      z5 = ({
        isLoading: e = !1,
        ...
        let o = a.createElement(D5, { icon: i === 'user' ? 'useralt' : 'repository', type: i }),
          s = {}
        return (
          e
          ...
          a.createElement(H5, { size: r, isLoading: e, src: n, type: i, ...s, ...l }, o)
        )
      },
      U5 = k.span(
        (e) =>
      ...
      $5 = k.a(
        {
          ...
          '&:active': { transform: 'translateY(0)', color: Ri(0.1, D.secondary) },
          svg: {
            display: 'inline-block',
            height: '1em',
            width: '1em',
        ...
        (e) => ({
          ...(e.secondary && {
            ...
            '&:active': { color: e.theme.base === 'light' ? D.darker : D.lighter },
          }),
          ...(e.tertiary && {
            color: D.dark,
    ...
    Ms.displayName = 'LinkComponentPicker'
    var xe = Y(({ children: e, withArrow: t, ...n }, r) => {
      let i = a.createElement(
        a.Fragment,
        null,
        a.createElement(U5, { withArrow: !!t }, e, t && a.createElement(vl, { icon: 'arrowright' }))
      )
      return a.createElement($5, { as: Ms, ref: r, ...n }, i)
    })
    xe.displayName = 'Link'
    xe.defaultProps = {
      withArrow: !1,
    ...
    var G5 = k.label((e) => ({
      ...
      K5 = k.input({
        ...
        '&:-webkit-autofill': { WebkitBoxShadow: `0 0 0 3em ${D.lightest} inset` },
      }),
      J5 = (e) => {
      ...
      Q5 = k.div((e) => ({
        ...
        '> svg': {
          ...
          ...(e.error && { animation: `${P5} 700ms ease-out`, path: { fill: D.red } }),
        },
      })),
      X5 = k.div(
        (e) =>
      ...
      Ts = Y(
        (
          ...
          let [g, v] = be(_o({ error: r, value: y, lastErrorValue: d })),
            E = `${e}-error`
          J(() => {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              o && a.createElement(vl, { icon: o, 'aria-hidden': !0 }),
              a.createElement(
                eu,
                {
                  tabIndex: -1,
                  ...
                  startOpen: !0,
                  hasChrome: !!g && !f,
                  tooltip: g && !f && a.createElement(tu, { desc: g }),
                  role: 'none',
                },
                S
              ),
    ...
    var _s = Y(({ type: e, startFocused: t, ...n }, r) => {
      ...
      return (
        ...
        a.createElement(Ts, { ref: d, startingType: e, type: i, onActionClick: o, ...n })
      )
    })
    ...
    var au = k.div(
      ...
      bl = ({ active: e, activeColor: t, disabled: n, isLoading: r, theme: i }) => ({
        ...
        ...(r && { '.sbds-list-item-title': { ...V5, flex: '0 1 auto', display: 'inline-block' } }),
        ...(n && {
          cursor: 'not-allowed !important',
          '.sbds-list-item-title, .sbds-list-item-center': { color: i.color.mediumdark },
        }),
      }),
      cu = k(({ active: e, activeColor: t, isLoading: n, ...r }) => a.createElement('a', { ...r }))(
        bl
      ),
      uu = k.span(bl),
      mu = ru((e) =>
        k(({ active: t, isLoading: n, activeColor: r, ...i }) => a.createElement(e, { ...i }))(bl)
      ),
      Je = ({
        ...
        let c = un().color[e],
          m = a.createElement(
            ...
            t && a.createElement(iu, { className: 'sbds-list-item-left' }, t),
            n && a.createElement(lu, { className: 'sbds-list-item-title' }, n),
            r && a.createElement(ou, { className: 'sbds-list-item-center' }, r),
            i && a.createElement(su, { className: 'sbds-list-item-right' }, i)
          )
        if (o) {
          let u = mu(o)
          return a.createElement(Io, null, a.createElement(u, { activeColor: c, ...d }, m))
        }
        return a.createElement(Io, null, a.createElement(s ? cu : uu, { activeColor: c, ...d }, m))
      },
      Q = {}
    Kd(Q, {
      BRAND: () => Pu,
    ...
    var T = le.arrayToEnum([
      ...
      pu = (e) => JSON.stringify(e, null, 2).replace(/"([^"]+)":/g, '$1:'),
    ...
    var Me = class {
        ...
        static mergeObjectSync(e, t) {
          ...
          for (let r of t) {
            let { key: i, value: l } = r
            if (i.status === 'aborted' || l.status === 'aborted') return U
    ...
    var ee = class {
        ...
        brand() {
          return new kl({ typeName: $.ZodBranded, type: this, ...X(this._def) })
        }
        catch(e) {
          let t = typeof e == 'function' ? e : () => e
          return new wa({ ...X(this._def), innerType: this, catchValue: t, typeName: $.ZodCatch })
        }
        describe(e) {
      ...
      Eu = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
      ku = /^[a-z0-9_-]{21}$/i,
      wu = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
      Cu =
        /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
      Su = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
      ...
      Mu = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
      Tu = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/,
      Os =
    ...
    function Ou(e, t) {
      return !!(((t === 'v4' || !t) && Au.test(e)) || ((t === 'v6' || !t) && Fu.test(e)))
    }
    function Zu(e, t) {
    ...
    function Ru(e, t) {
      return !!(((t === 'v4' || !t) && Lu.test(e)) || ((t === 'v6' || !t) && Nu.test(e)))
    }
    var mt = class extends ee {
      _parse(e) {
        if ((this._def.coerce && (e.data = String(e.data)), this._getType(e) !== T.string)) {
          let r = this._getOrReturnCtx(e)
          return (M(r, { code: x.invalid_type, expected: T.string, received: r.parsedType }), U)
        }
        let t = new Me(),
          n
    ...
    mt.create = (e) =>
      new mt({ checks: [], typeName: $.ZodString, coerce: e?.coerce ?? !1, ...X(e) })
    function Bu(e, t) {
    ...
    var Xt = class extends ee {
      ...
      _parse(e) {
        if ((this._def.coerce && (e.data = Number(e.data)), this._getType(e) !== T.number)) {
          let r = this._getOrReturnCtx(e)
          return (M(r, { code: x.invalid_type, expected: T.number, received: r.parsedType }), U)
        }
        let t,
          n = new Me()
        for (let r of this._def.checks)
    ...
    Xt.create = (e) =>
      new Xt({ checks: [], typeName: $.ZodNumber, coerce: e?.coerce || !1, ...X(e) })
    var en = class extends ee {
      ...
      _getInvalidInput(e) {
        ...
        return (M(t, { code: x.invalid_type, expected: T.bigint, received: t.parsedType }), U)
      }
      gte(e, t) {
        return this.setLimit('min', e, !0, P.toString(t))
      }
    ...
    en.create = (e) =>
      new en({ checks: [], typeName: $.ZodBigInt, coerce: e?.coerce ?? !1, ...X(e) })
    var pa = class extends ee {
      _parse(e) {
        if ((this._def.coerce && (e.data = !!e.data), this._getType(e) !== T.boolean)) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { code: x.invalid_type, expected: T.boolean, received: t.parsedType }), U)
        }
        return Te(e.data)
      }
    }
    pa.create = (e) => new pa({ typeName: $.ZodBoolean, coerce: e?.coerce || !1, ...X(e) })
    var Sn = class extends ee {
      _parse(e) {
        if ((this._def.coerce && (e.data = new Date(e.data)), this._getType(e) !== T.date)) {
          let r = this._getOrReturnCtx(e)
          return (M(r, { code: x.invalid_type, expected: T.date, received: r.parsedType }), U)
        }
        if (Number.isNaN(e.data.getTime())) {
          let r = this._getOrReturnCtx(e)
          return (M(r, { code: x.invalid_date }), U)
        }
        let t = new Me(),
          n
        for (let r of this._def.checks)
    ...
    Sn.create = (e) => new Sn({ checks: [], coerce: e?.coerce || !1, typeName: $.ZodDate, ...X(e) })
    var ur = class extends ee {
      _parse(e) {
        if (this._getType(e) !== T.symbol) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { code: x.invalid_type, expected: T.symbol, received: t.parsedType }), U)
        }
        return Te(e.data)
      }
    }
    ...
    var ha = class extends ee {
      _parse(e) {
        if (this._getType(e) !== T.undefined) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { code: x.invalid_type, expected: T.undefined, received: t.parsedType }), U)
        }
        return Te(e.data)
      }
    }
    ...
    var fa = class extends ee {
      _parse(e) {
        if (this._getType(e) !== T.null) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { code: x.invalid_type, expected: T.null, received: t.parsedType }), U)
        }
        return Te(e.data)
      }
    }
    ...
    var At = class extends ee {
      _parse(e) {
        let t = this._getOrReturnCtx(e)
        return (M(t, { code: x.invalid_type, expected: T.never, received: t.parsedType }), U)
      }
    }
    ...
    var mr = class extends ee {
      _parse(e) {
        if (this._getType(e) !== T.undefined) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { code: x.invalid_type, expected: T.void, received: t.parsedType }), U)
        }
        return Te(e.data)
      }
    }
    ...
    var ft = class extends ee {
      _parse(e) {
        ...
        if (t.parsedType !== T.array)
          return (M(t, { code: x.invalid_type, expected: T.array, received: t.parsedType }), U)
    ...
    var ve = class extends ee {
      ...
      _parse(e) {
        if (this._getType(e) !== T.object) {
          ...
          return (M(s, { code: x.invalid_type, expected: T.object, received: s.parsedType }), U)
        }
      ...
      pick(e) {
        let t = {}
        for (let n of le.objectKeys(e)) e[n] && this.shape[n] && (t[n] = this.shape[n])
        return new ve({ ...this._def, shape: () => t })
      }
      omit(e) {
        let t = {}
        for (let n of le.objectKeys(this.shape)) e[n] || (t[n] = this.shape[n])
        return new ve({ ...this._def, shape: () => t })
      }
      deepPartial() {
        return fn(this)
    ...
    var ga = class extends ee {
      _parse(e) {
        ...
        function r(i) {
          ...
          return (M(t, { code: x.invalid_union, unionErrors: l }), U)
        }
        if (t.common.async)
          return Promise.all(
            n.map(async (i) => {
          ...
          ).then(r)
        {
          ...
          return (M(t, { code: x.invalid_union, unionErrors: o }), U)
        }
      }
      get options() {
    ...
    ga.create = (e, t) => new ga({ options: e, typeName: $.ZodUnion, ...X(t) })
    var Tt = (e) =>
        e instanceof ya
          ? Tt(e.schema)
          : e instanceof Xe
                    ...
                    : e instanceof ha
                      ...
                      : e instanceof fa
                        ...
                        : e instanceof gt
                          ...
                          : e instanceof Ot
                            ? [null, ...Tt(e.unwrap())]
                            : e instanceof kl || e instanceof Ca
                              ? Tt(e.unwrap())
                              : e instanceof wa
                                ? Tt(e._def.innerType)
                                : [],
      El = class extends ee {
        _parse(e) {
          ...
          if (t.parsedType !== T.object)
            return (M(t, { code: x.invalid_type, expected: T.object, received: t.parsedType }), U)
        ...
        let { status: t, ctx: n } = this._processInputParams(e),
          r = (i, l) => {
            ...
            return o.valid
              ...
              : (M(n, { code: x.invalid_intersection_types }), U)
          }
        return n.common.async
          ? Promise.all([
    ...
    va.create = (e, t, n) => new va({ left: e, right: t, typeName: $.ZodIntersection, ...X(n) })
    var Lt = class extends ee {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e)
        if (n.parsedType !== T.array)
          return (M(n, { code: x.invalid_type, expected: T.array, received: n.parsedType }), U)
    ...
    Lt.create = (e, t) => {
      ...
      return new Lt({ items: e, typeName: $.ZodTuple, rest: null, ...X(t) })
    }
    var pr = class extends ee {
        ...
        _parse(e) {
          ...
          if (n.parsedType !== T.object)
            return (M(n, { code: x.invalid_type, expected: T.object, received: n.parsedType }), U)
          let r = [],
            i = this._def.keyType,
        ...
        static create(e, t, n) {
          return t instanceof ee
            ? new pr({ keyType: e, valueType: t, typeName: $.ZodRecord, ...X(n) })
            : new pr({ keyType: mt.create(), valueType: e, typeName: $.ZodRecord, ...X(t) })
        }
      },
      hr = class extends ee {
        get keySchema() {
        ...
        _parse(e) {
          ...
          if (n.parsedType !== T.map)
            return (M(n, { code: x.invalid_type, expected: T.map, received: n.parsedType }), U)
          ...
          if (n.common.async) {
            ...
            return Promise.resolve().then(async () => {
              for (let s of l) {
                let d = await s.key,
                  c = await s.value
                if (d.status === 'aborted' || c.status === 'aborted') return U
    ...
    hr.create = (e, t, n) => new hr({ valueType: t, keyType: e, typeName: $.ZodMap, ...X(n) })
    var An = class extends ee {
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e)
        if (n.parsedType !== T.set)
          return (M(n, { code: x.invalid_type, expected: T.set, received: n.parsedType }), U)
        let r = this._def
        ;(r.minSize !== null &&
        ...
        let o = [...n.data.values()].map((s, d) => i._parse(new yt(n, s, n.path, d)))
        return n.common.async ? Promise.all(o).then((s) => l(s)) : l(o)
      }
      min(e, t) {
        return new An({ ...this._def, minSize: { value: e, message: P.toString(t) } })
      }
      max(e, t) {
        return new An({ ...this._def, maxSize: { value: e, message: P.toString(t) } })
      }
      size(e, t) {
    ...
    An.create = (e, t) =>
      new An({ valueType: e, minSize: null, maxSize: null, typeName: $.ZodSet, ...X(t) })
    var da = class extends ee {
        ...
        _parse(e) {
          ...
          if (t.parsedType !== T.function)
            return (M(t, { code: x.invalid_type, expected: T.function, received: t.parsedType }), U)
          function n(o, s) {
            return cr({
              data: o,
              path: t.path,
              errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, dr(), Cn].filter(
                (d) => !!d
              ),
        ...
        args(...e) {
          return new da({ ...this._def, args: Lt.create(e).rest(Yt.create()) })
        }
        returns(e) {
    ...
    ya.create = (e, t) => new ya({ getter: e, typeName: $.ZodLazy, ...X(t) })
    var ba = class extends ee {
      _parse(e) {
        if (e.data !== this._def.value) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { received: t.data, code: x.invalid_literal, expected: this._def.value }), U)
        }
    ...
    ba.create = (e, t) => new ba({ value: e, typeName: $.ZodLiteral, ...X(t) })
    function Bs(e, t) {
      ...
      _parse(e) {
        if (typeof e.data != 'string') {
          let t = this._getOrReturnCtx(e),
            n = this._def.values
          return (
            M(t, { expected: le.joinValues(n), received: t.parsedType, code: x.invalid_type }),
            U
          )
        }
        if ((this._cache || (this._cache = new Set(this._def.values)), !this._cache.has(e.data))) {
          let t = this._getOrReturnCtx(e),
            n = this._def.values
          return (M(t, { received: t.data, code: x.invalid_enum_value, options: n }), U)
        }
        return Te(e.data)
      }
      get options() {
    ...
    var Ea = class extends ee {
      _parse(e) {
        ...
        if (n.parsedType !== T.string && n.parsedType !== T.number) {
          ...
          return (
            M(n, { expected: le.joinValues(r), received: n.parsedType, code: x.invalid_type }),
            U
          )
        }
        if (
          ...
          let r = le.objectValues(t)
          return (M(n, { received: n.data, code: x.invalid_enum_value, options: r }), U)
        }
        return Te(e.data)
      }
      get enum() {
    ...
    Ea.create = (e, t) => new Ea({ values: e, typeName: $.ZodNativeEnum, ...X(t) })
    var Ln = class extends ee {
      ...
      _parse(e) {
        ...
        if (t.parsedType !== T.promise && t.common.async === !1)
          return (M(t, { code: x.invalid_type, expected: T.promise, received: t.parsedType }), U)
    ...
    Ln.create = (e, t) => new Ln({ type: e, typeName: $.ZodPromise, ...X(t) })
    ...
    Xe.create = (e, t, n) => new Xe({ schema: e, typeName: $.ZodEffects, effect: t, ...X(n) })
    ...
    gt.create = (e, t) => new gt({ innerType: e, typeName: $.ZodOptional, ...X(t) })
    var Ot = class extends ee {
      _parse(e) {
        return this._getType(e) === T.null ? Te(null) : this._def.innerType._parse(e)
      }
      unwrap() {
        return this._def.innerType
      }
    }
    Ot.create = (e, t) => new Ot({ innerType: e, typeName: $.ZodNullable, ...X(t) })
    ...
    var fr = class extends ee {
      _parse(e) {
        if (this._getType(e) !== T.nan) {
          let t = this._getOrReturnCtx(e)
          return (M(t, { code: x.invalid_type, expected: T.nan, received: t.parsedType }), U)
        }
        return { status: 'valid', value: e.data }
      }
    }
    ...
    Ca.create = (e, t) => new Ca({ innerType: e, typeName: $.ZodReadonly, ...X(t) })
    function Zo(e, t) {
    ...
    var Hu = (e, t = { message: `Input not instance of ${e.name}` }) =>
      ...
      S2 = (typeof window < 'u' && window.__CHROMATIC_STORYBOOK_ID__) || 'unscoped',
    ...
    function oa(e) {
      ...
      for (
        ...
        if (!p[f]) {
          ...
          ;((c[u] = (i(f, 0.5) * l) | 0), (m[u++] = (i(f, 1 / 3) * l) | 0))
        }
              ...
              (h[n] =
                n < 16
                  ...
                  : (h[n - 16] +
                    ...
                    0)
          ;(c = [
            (E + ((t(g, 2) ^ t(g, 13) ^ t(g, 22)) + ((g & c[1]) ^ (g & c[2]) ^ (c[1] & c[2])))) | 0,
          ].concat(c))[4] = (c[4] + E) | 0
        }
    ...
    var js = /^[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?$/,
      ...
      x2 = Q.object({
        version: Q.literal(2),
        accessToken: Q.string().min(1),
        refreshToken: Q.string().min(1),
        subdomain: Q.string().regex(js).optional(),
        sessionId: Q.string().min(1),
      }),
      A2 = Q.object({
        access_token: Q.string().min(1),
        refresh_token: Q.string().min(1).optional(),
      ...
      F2 = (e) => String.fromCharCode(...e),
      N2 = (e) => window.btoa(Array.isArray(e) ? F2(e) : e),
      Us = (e) => N2(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, ''),
      M2 = (e) => Array.from(e.match(/.{1,2}/g) ?? [], (t) => parseInt(t, 16)),
      Bo = (e) => {
      ...
      $s = (e) => {
        ...
        let t = new URL(gr)
        return (
          t.hostname.startsWith('www.') && (t.hostname = `${e}.${t.hostname.slice(4)}`),
          t.origin
        )
      },
      Ws = (e) => `${$s(e)}/token`,
      ...
      Gs = async (e, t) => {
        ...
        if (!e.ok) {
          let l = n?.error_description || n?.error || `${t} (${e.status})`
          throw new Error(l)
        }
      ...
      T2 = async ({ codeVerifier: e, redirectUri: t, sessionId: n, subdomain: r, code: i }) => {
        ...
        if (!o.refresh_token) throw new Error('Token exchange failed: missing refresh token')
        return {
          version: 2,
      ...
      _2 = async ({ subdomain: e, refreshToken: t, sessionId: n, signal: r }) => {
        let i = await fetch(Ws(e), {
          ...
          body: Cl({ client_id: ml, grant_type: 'refresh_token', refresh_token: t }),
        })
        if (!i.ok) {
      ...
      Br = $e(null),
      I2 = ({ children: e, value: t }) => a.createElement(Br.Provider, { value: t }, e),
      De = (e, t) => {
        let n = Et(Br, 'Telemetry')
        J(() => n({ location: e, screen: t }), [e, t, n])
      }
    function Ys() {
      let e = Nt(),
      ...
      return z(
        (l, o) => {
          t({
            ...
            icon: a.createElement(Jt, { color: cn.negative }),
            onClick: i,
          })
        },
        [t, i]
        ...
        l = kt(
          () =>
            zi(
              e,
              (s) => {
                let d = new Set(sessionStorage.getItem(`${j}/state`)?.split(';'))
                ;(s == null
                  ? (sessionStorage.removeItem(`${j}/state/${e}`), d.delete(e))
                  : (sessionStorage.setItem(`${j}/state/${e}`, JSON.stringify(s)), d.add(e)),
                  sessionStorage.setItem(`${j}/state`, Array.from(d).join(';')),
    ...
    function O2(...e) {
      ...
      ;(n.forEach((r) => sessionStorage.removeItem(`${j}/state/${r}`)),
        e.length
          ? sessionStorage.setItem(`${j}/state`, t.filter((r) => !e.includes(r)).join(';'))
          : sessionStorage.removeItem(`${j}/state`),
        n.forEach((r) => {
          window.dispatchEvent(new StorageEvent('session-storage', { key: r }))
        }))
    }
    var Ks = $e(void 0),
      Z2 = ({ children: e, addonUninstalled: t, setAddonUninstalled: n }) => {
        let r = Nt().getChannel()
    ...
    var B2 = k.div({ display: 'flex', fontWeight: 'bold', marginBottom: 15 })
    k(kc)(({ theme: e }) => ({
      width: 12,
      height: 12,
      margin: '3px 6px',
    ...
    var Pr = { width: 14, height: 14, margin: '2px 6px 2px 0', verticalAlign: 'top' }
    k(Ic)(Pr)
    k(sc)(Pr)
    k(ms)(Pr)
    k(uc)(Pr)
    var P2 = k(ul)({ marginLeft: 'auto' }),
      ...
      Sl = class {
        ...
        set(e, t) {
          ...
          ;((this.state[e] = { index: n, value: t }), this.channel.emit(za, e, t, n))
        }
    ...
    var H2 = {
      ...
      Do = k.div({ display: 'flex', flexGrow: 1, flexWrap: 'wrap', gap: '5px 10px' }),
      jo = k.div(({ theme: e }) => ({
        fontWeight: e.typography.weight.bold,
              ...
              a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        Do,
                        null,
                        a.createElement(jo, null, c, ' '),
                        c in Gc && a.createElement(q2, null, '*Disabled for local builds')
                      ),
                      a.createElement(Uo, null, H2[c]?.description),
                      a.createElement(
                        zo,
                        null,
                        a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Ho,
                    null,
                    a.createElement(Do, null, a.createElement(jo, null, 'Uninstall addon')),
                    a.createElement(
                      Uo,
                      null,
                    ...
                    a.createElement(
                      zo,
                      null,
                      a.createElement(re, { ariaLabel: !1, onClick: t }, 'Uninstall')
                    )
                  )
                )
              )
      ...
      e0 = { configVisible: !1, baselineImageVisible: !1, focusVisible: !1, diffVisible: !1 },
      Ua = (e) => (t, n) => ({ ...t, [e]: typeof n == 'boolean' ? n : !t[e] }),
      Q2 = {
              ...
              a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(V.Icon, null, a.createElement(ps, null)),
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(V.Icon, null, a.createElement(pc, null)),
                ...
                o &&
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(V.Icon, null, a.createElement(mc, null)),
                ...
                e &&
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(V.Icon, null, a.createElement(Oc, null)),
    ...
    var tm = k.div(
      ...
      im = ({ hidden: e, ignoreConfig: t, ignoreSuggestions: n, onOpen: r }) => {
        let [i] = Ee(pl),
          l = Object.keys(i?.problems || {}),
          o = Object.keys(i?.suggestions || {}),
          [s, d] = be(() => !!localStorage.getItem(No)),
          c = z(() => {
            ;(d(!0), localStorage.setItem(No, 'true'))
          }, []),
          m = a.createElement(
            xe,
      ...
      lm = k.div({ display: 'flex', flexDirection: 'column', height: '100%' }),
      ...
      he = ({
        ...
        return a.createElement(
          lm,
          null,
          a.createElement(im, { onOpen: s, hidden: l, ignoreConfig: n, ignoreSuggestions: r }),
          a.createElement(qo, { hidden: l, interstitial: i }, e),
          a.createElement(qo, { hidden: !l }, a.createElement(J2, { onClose: () => o(!1) })),
          t
        )
      },
      oe = k.div((e) => ({
      ...
      a0 = ({ id: e, value: t, placeholder: n, suffix: r, ...i }) =>
        a.createElement(
          ...
          a.createElement(dm, { value: t, placeholder: n, suffix: r })
        ),
      q = k.div(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(de, null, 'Sign in to begin visual testing'),
                a.createElement(
                  q,
                  { center: !0, muted: !0 },
...
`),
        ...
        (($a.lastIndex = 0),
          $a.test(t[o]) &&
            (o && (!r || $a.lastIndex < r) && (r = $a.lastIndex), (i = i || o), (l = o)))
      for (var s = i; s <= l; s++)
        (s !== i &&
          (n += `
`),
    ...
    function Fn(e) {
      ...
      switch (B.charCodeAt(A)) {
        case 91:
          ;(A++, ae())
          for (var n = []; B.charCodeAt(A) !== 93; ) n.push(Fn(e))
        ...
        case 123:
          ...
          for (var r = []; B.charCodeAt(A) !== 125; ) {
            ...
            ;(ae(), r.push({ kind: 'ObjectField', name: i, value: Fn(e) }))
          }
        ...
        case 34:
          if (B.charCodeAt(A + 1) === 34 && B.charCodeAt(A + 2) === 34) {
            if (((A += 3), (t = Go(bm)) == null)) throw Fe('StringValue')
            return (ae(), { kind: 'StringValue', value: ym(t.slice(0, -3)), block: !0 })
          } else {
            var l = A,
              o
            A++
        ...
        case 57:
          ...
          if ((c = B.charCodeAt(A)) === 46 || c === 69 || c === 101) {
            if ((t = Go(Em)) == null) throw Fe('FloatValue')
        ...
        case 116:
          if (
            ...
            return ((A += 4), ae(), { kind: 'BooleanValue', value: !0 })
          break
        case 102:
          if (
            B.charCodeAt(A + 1) === 97 &&
            ...
            return ((A += 5), ae(), { kind: 'BooleanValue', value: !1 })
          break
      }
      return { kind: 'EnumValue', value: Fl() }
    }
    function r0(e) {
      if (B.charCodeAt(A) === 40) {
        ...
        do {
          ...
          ;(ae(), t.push({ kind: 'Argument', name: n, value: Fn(e) }))
    ...
    function _t(e) {
      if (B.charCodeAt(A) === 64) {
        var t = []
        do (A++, t.push({ kind: 'Directive', name: Oe(), arguments: r0(e) }))
    ...
    function km() {
      ...
      do
        if ((B.charCodeAt(A) === 33 && (A++, ae(), (t = { kind: 'NonNullType', type: t })), e)) {
    ...
    function wm() {
      if ((ae(), B.charCodeAt(A) === 40)) {
        ...
        do {
          var t = void 0
          if ((B.charCodeAt(A) === 34 && (t = Fn(!0)), B.charCodeAt(A++) !== 36))
            throw Fe('Variable')
          var n = Oe()
          ...
          var r = km(),
            i = void 0
          ;(B.charCodeAt(A) === 61 && (A++, ae(), (i = Fn(!0))), ae())
          var l = {
    ...
    function Yo() {
      ...
      do {
        var t = void 0
        if ((B.charCodeAt(A) === 34 && (t = Fn(!0)), B.charCodeAt(A) === 123)) {
...
`),
            ...
            e.variableDefinitions &&
              ...
              (e.name || (t += ' '),
              (t += '(' + Ie(e.variableDefinitions, ', ', ge.VariableDefinition) + ')')),
            e.directives && e.directives.length && (t += ' ' + Ie(e.directives, ' ', ge.Directive)))
        ...
        VariableDefinition(e) {
          var t = ''
          return (
            e.description && (t += ge.StringValue(e.description) + ' '),
        ...
        StringValue(e) {
          return e.block ? Am(e.value).replace(/\n/g, st) : xm(e.value)
        },
        ...
        ObjectValue: (e) => '{' + Ie(e.fields, ', ', ge.ObjectField) + '}',
...
`,
        ...
        SelectionSet: (e) =>
          '{' + (st += '  ') + Ie(e.selections, st, wt) + (st = st.slice(0, -2)) + '}',
...
`),
    ...
    var Ko = () => (typeof Symbol == 'function' && Symbol.asyncIterator) || '@@asyncIterator',
      Fm = (e) => e
    function Re(e) {
      return (t) => (n) => {
        var r = Ve
    ...
    var Zm = (e) =>
        e && typeof e.message == 'string' && (e.extensions || e.name === 'GraphQLError')
          ...
          : typeof e == 'object' && typeof e.message == 'string'
            ? new Ui(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {})
            : new Ui(e),
...
`),
      ...
      gn = (e, t) => {
        ...
        if (Array.isArray(e)) {
          for (var n = '[', r = 0, i = e.length; r < i; r++)
            (n.length > 1 && (n += ','), (n += gn(e[r], t) || 'null'))
          return (n += ']')
        } else if (!t && ((kr !== Mn && e instanceof kr) || (wr !== Mn && e instanceof wr)))
          return 'null'
        ...
        if (
          ...
          var o = Qo.get(e) || Math.random().toString(36).slice(2)
          return (Qo.set(e, o), gn({ __key: o }, t))
        }
        Kt.add(e)
        for (var s = '{', d = 0, c = l.length; d < c; d++) {
          var m = gn(e[l[d]], t)
          m && (s.length > 1 && (s += ','), (s += gn(l[d], t) + ':' + m))
        }
        return (Kt.delete(e), (s += '}'))
      },
      qi = (e, t, n) => {
        if (!(n == null || typeof n != 'object' || n.toJSON || Kt.has(n)))
      ...
      Mn = class {},
      kr = typeof File < 'u' ? File : Mn,
      wr = typeof Blob < 'u' ? Blob : Mn,
      Rm = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g,
      Bm = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g,
      Pm = (e, t) =>
        t % 2 == 0
...
# ${n}`,
      ...
      Vm = (e) => {
        ...
        return (
          typeof e == 'string'
            ? ((t = t1(e)), (n = lr.get(t) || Sm(e, { noLocation: !0 })))
      ...
      yn = (e, t, n) => {
        var r = t || {},
          ...
          l = Er(r, !0),
          o = i.__key
        return (l !== '{}' && (o = ir(l, o)), { key: o, query: i, variables: r, extensions: n })
      },
      u0 = (e) => {
        for (var t = 0, n = e.definitions.length; t < n; t++) {
          var r = e.definitions[t]
          if (r.kind === vm.OPERATION_DEFINITION) return r.name ? r.name.value : void 0
        }
      },
      n1 = (e, t, n) => {
        ...
        return {
          ...
          error: Array.isArray(t.errors)
            ? new Tl({ graphQLErrors: t.errors, response: n })
            : void 0,
      ...
      Cr = (e, t) => {
        if (typeof e == 'object' && e != null) {
          if (Array.isArray(e)) {
            e = [...e]
            for (var n = 0, r = t.length; n < r; n++) e[n] = Cr(e[n], t[n])
            return e
          }
      ...
      Hm = (e, t, n, r) => {
          ...
          for (
            var c = function () {
                ...
                if (p.path) y = p.path
                  ...
                  p.subPath ? (y = [...w.path, ...p.subPath]) : (y = w.path)
                }
                for (var b = 0, g = y.length; b < g; f = y[b++])
                  h = h[f] = Array.isArray(h[f]) ? [...h[f]] : { ...h[f] }
                if (p.items)
                  for (var v = +f >= 0 ? f : 0, E = 0, S = p.items.length; E < S; E++)
                    h[v + E] = Cr(h[v + E], p.items[E])
                else p.data !== void 0 && (h[f] = Cr(h[f], p.data))
              },
              m = 0,
              u = s.length;
            m < u;
        ...
        return {
          ...
          data: d.data,
          error: i.length ? new Tl({ graphQLErrors: i, response: n }) : void 0,
      ...
      m0 = (e, t, n) => ({
        operation: e,
        data: void 0,
        error: new Tl({ networkError: t, response: n }),
        extensions: void 0,
        hasNext: !1,
        stale: !1,
      })
      ...
      Um = (e, t) => {
        if (t && !(e.kind === 'query' && e.context.preferGetMethod)) {
          var n = Er(t),
            r = ((s) => {
              var d = new Map()
              return ((kr !== Mn || wr !== Mn) && (Kt.clear(), qi(d, 'variables', s)), d)
            })(t.variables)
          if (r.size) {
            var i = new FormData()
...
`
    ...
    function i1(e) {
      var t = (n) => e(n)
      return (
        (t.toPromise = () => Ml(Dr(1)(Re((n) => !n.stale && !n.hasNext)(t)))),
        (t.then = (n, r) => t.toPromise().then(n, r)),
        (t.subscribe = (n) => Nn(n)(t)),
        t
      )
    }
    function Sr(e, t, n) {
    ...
    var Km = () => {},
        ...
        (n) => {
          var r = o0((l) => {
              var o = Dm(l),
                s = jm(l, o),
                d = $m(l, o),
                c = s0(Re((m) => m.kind === 'teardown' && m.key === l.key)(n))(Ym(l, s, d))
              return c
            })(
              Re(
                (l) =>
      ...
      e4 = function e(t) {
        var n = 0,
          ...
          d = Wi()
        function c(g) {
          ;(g.kind === 'mutation' || g.kind === 'teardown' || !l.has(g.key)) &&
            (g.kind === 'teardown' ? l.delete(g.key) : g.kind !== 'mutation' && l.add(g.key),
            d.next(g))
        }
        var m = !1
        function u(g) {
        ...
        var p = (g) => {
            var v = s0(Re((E) => E.kind === 'teardown' && E.key === g.key)(d.source))(
              Re(
                (E) =>
                ...
                : (v = Jo((E) => {
                    ...
                    return E.stale || E.hasNext
                      ...
                      : Sa([
                          S,
                          l0(() => ((E.stale = !0), E))(
                            Dr(1)(Re((L) => L.key === g.key)(d.source))
                          ),
                        ])
                  })(v)),
              g.kind !== 'mutation'
                ? (v = Nl(() => {
                    ;(l.delete(g.key), r.delete(g.key), i.delete(g.key), (m = !1))
                    for (var E = o.length - 1; E >= 0; E--) o[E].key === g.key && o.splice(E, 1)
          ...
          h = Object.assign(f, {
            ...
            reexecuteOperation(g) {
              ...
              else if (g.kind === 'mutation') (o.push(g), Promise.resolve().then(u))
              else if (i.has(g.key)) {
                for (var v = !1, E = 0; E < o.length; E++)
                  o[E].key === g.key && ((o[E] = g), (v = !0))
                v || (l.has(g.key) && g.context.requestPolicy !== 'network-only')
                  ? (l.delete(g.key), Promise.resolve().then(u))
                ...
                : i1(
                    Mm(() => {
                      ...
                      return g.kind === 'query' && E && (E.stale || E.hasNext)
                        ? Jo(pi)(Sa([v, Re((S) => S === r.get(g.key))(pi(E))]))
                        : v
                    })
                  )
            },
            ...
            executeSubscription(g, v) {
              var E = h.createRequestOperation('subscription', g, v)
              return h.executeRequestOperation(E)
            },
            executeMutation(g, v) {
            ...
            subscription: (g, v, E) => h.executeSubscription(yn(g, v), E),
            mutation: (g, v, E) => h.executeMutation(yn(g, v), E),
          }),
          y = Km,
          w = Qm(t.exchanges),
          b = xa(w({ client: h, dispatchDebug: y, forward: Xm({ dispatchDebug: y }) })(d.source))
        return (Om(b), h)
      },
      t4 = {},
      jr = $e(t4),
    ...
    var Il = () => {
      ...
      hi = (e, t) => {
        ...
        return ((r, i) => {
          ...
          for (var o in i) if (o === 'operation' ? !a4(r[o], i[o]) : r[o] !== i[o]) return !0
          return !1
        })(e, n)
          ? n
          : e
    ...
    var l4 = (e) => {
      ...
      o4 = (e, t) => (t && t.suspense !== void 0 ? !!t.suspense : e.suspense)
    function Ol(e) {
      var t = Il(),
        n = l4(t),
        r = o4(t, e.context),
          ...
          (p, f) => {
            ...
            if (h) {
              ...
              var y,
                w = Nn((g) => {
                  ;((h = g), y && y(h))
                })(d0(() => (f && !y) || !h || ('hasNext' in h && h.hasNext))(p))
              if (h == null && f) {
                var b = new Promise((g) => {
                  y = g
                })
    ...
    var s4 = Q.union([
        Q.object({ message: Q.literal('login') }),
        Q.object({ message: Q.literal('grant'), code: Q.string(), state: Q.string() }),
        Q.object({
          message: Q.literal('grant'),
          error: Q.string(),
          error_description: Q.string().optional(),
          state: Q.string().optional(),
        }),
        Q.object({ message: Q.literal('createdProject'), projectId: Q.string() }),
      ]),
      h0 = (e) => {
        let t = me(),
          n = me(new Set())
          ...
          [
            z((r, i = []) => {
              if (window.innerWidth > 800 && window.innerHeight > 800) {
                ...
                ;((t.current = window.open(r, 'chromatic-dialog', s)), t.current?.focus())
              } else t.current = window.open(r, '_blank')
              if (!t.current) return ((n.current = new Set()), !1)
              let { origin: l } = new URL(r)
              return ((n.current = new Set([l, ...i])), !0)
            }, []),
            z(() => {
              ;(t.current?.close(), (t.current = null), (n.current = new Set()))
            }, []),
          ]
        )
      },
      ...
      c4 = Q.object({ message: Q.literal('grant'), code: Q.string(), state: Q.string() }),
      u4 = (e, t) => T2({ ...e, code: t }),
      m4 = (e, t) => {
        ...
        if (n.success)
          return n.data.state !== t
            ? { kind: 'ignore' }
            : { kind: 'error', message: n.data.error_description || n.data.error }
        let r = c4.safeParse(e)
        return r.success
          ? r.data.state !== t
            ? { kind: 'error', message: 'Invalid OAuth state' }
            : { kind: 'code', code: r.data.code }
          : { kind: 'error', message: 'Unexpected OAuth callback payload' }
      }
    function f0({ onAuthenticated: e, onError: t, onMessage: n }) {
      let r = me(null),
        ...
        o = z(
          async (c) => {
            let m = { closeDialog: () => l.current?.(), openDialog: (p, f) => i.current?.(p, f) },
              u = r.current
            if (u) {
              let p = m4(c, u.state)
              if (p.kind === 'login') return
              if (p.kind === 'error') {
                ;((r.current = null), m.closeDialog(), t(new Error(p.message)))
                return
              }
              if (p.kind === 'code') {
                r.current = null
    ...
    function x4(e) {
      return ({ client: t, forward: n }) => {
        ...
        return (u) => {
          function p() {
            c = Promise.resolve()
              .then(() =>
                e({
                  mutate(b, g, v) {
                    var E = t.createRequestOperation('mutation', yn(b, g), v)
                    return Ml(
                      Dr(1)(
                        Re(
                          (S) =>
                  ...
                  appendHeaders(b, g) {
                    ...
                    return Sr(b.kind, b, {
                      ...b.context,
                      fetchOptions: { ...v, headers: { ...v.headers, ...g } },
                    })
                  },
                })
              )
          ...
          p()
          function f(b) {
            ;(o.set(b.key, fi(b, !0)), m && !c && (c = m.refreshAuth().then(s).catch(d)))
          }
          function h(b) {
                ...
                b.kind === 'teardown'
                  ...
                  : b.context._instance && r.has(b.context._instance)
                    ...
                    : b.context.authAttempt
                      ? h(b)
                      : c || !m
                        ? (c || p(), o.has(b.key) || o.set(b.key, fi(b, !1)), null)
                        : (function (g) {
                              return (
                                !g.context.authAttempt && m && m.willAuthError && m.willAuthError(g)
                              )
                            })(b)
                          ? (f(b), null)
                          : h(fi(b, !1))
          ...
          return Sa([
            ...
            Re((b) =>
              ...
              b.error &&
              (function (g) {
                return m && m.didAuthError && m.didAuthError(g.error, g.operation)
              })(b) &&
    ...
    var N4 = typeof crypto < 'u' && crypto.randomUUID && crypto.randomUUID.bind(crypto),
      l1 = { randomUUID: N4 }
    function M4(e, t, n) {
      if (l1.randomUUID && !t && !e) return l1.randomUUID()
      e = e || {}
      let r = e.random ?? e.rng?.() ?? F4()
    ...
    var T4 = M4,
      ...
      O4 = class {
        constructor() {
          ;((this.auth = null),
            ...
            (this.fallbackSessionId = T4()),
            (this.handleStorageEvent = (e) => {
              e.key === Yn && this.applyParsedAuth(e.newValue)
            }),
            this.loadFromStorage(),
            typeof window < 'u' && window.addEventListener('storage', this.handleStorageEvent))
        }
        get storage() {
        ...
        notifySessionExpired() {
          typeof window > 'u' || window.dispatchEvent(new window.CustomEvent(g0))
        }
        persist() {
          let e = this.storage
          e && (this.auth ? e.setItem(Yn, JSON.stringify(this.auth)) : e.removeItem(Yn))
        }
        applyParsedAuth(e) {
          let t = e ? I4(e) : null
          ;(e && !t && this.storage?.removeItem(Yn), this.setAuth(t, { persist: !1 }))
        }
        loadFromStorage() {
        ...
        identityChanged(e, t) {
          return e === t
            ...
            : !e || !t
              ? !0
              : e.refreshToken !== t.refreshToken || e.sessionId !== t.sessionId
        }
      ...
      Yi = (e) => vt.setAuth(e),
      zr = () => {
        let [{ token: e }, t] = Kl(`${j}/accessToken`, { token: vt.getToken() }),
          n = a.useCallback((r) => {
            vt.setToken(r)
          }, [])
        return (a.useEffect(() => vt.subscribe((r) => t({ token: r })), [t]), [e, n])
      },
      v0 = (e, t) => ({
        headers: {
          Accept: '*/*',
          ...
          exchanges: [
            x4(async (t) => ({
              addAuthToOperation(n) {
                let r = vt.getToken()
                return r ? t.appendHeaders(n, { Authorization: `Bearer ${r}` }) : n
              },
              didAuthError: (n) =>
      ...
      o1 = Z4,
      V4 = ({ children: e, value: t = y0() }) => a.createElement(n4, { value: t }, e),
      H4 = Q.object({ message: Q.literal('createdProject'), projectId: Q.string() }),
      D4 = tt(`
  query VisualTestsProjectCountQuery {
    viewer {
      projectCount
        ...
        let l = Il(),
          ...
          { begin: d } = f0({
            onAuthenticated: async (c, m) => {
              try {
                ...
                let u = v0(c.accessToken, c.sessionId),
                  { data: p } = await l.query(D4, {}, { fetchOptions: u })
                if (!p?.viewer) throw new Error('Failed to fetch initial project list')
                if (p.viewer.projectCount > 0 || t) {
                  ;(Yi(c), n(c.accessToken), m.closeDialog())
                  return
                }
                if (!p.viewer.accounts[0]) throw new Error('User has no accounts!')
                if (!p.viewer.accounts[0].newProjectUrl)
                  throw new Error('Unexpected missing project URL')
                m.openDialog(p.viewer.accounts[0].newProjectUrl)
              } catch (u) {
                o('Login Error', u)
              }
            },
            ...
            onMessage: (c, m) => {
              ...
              if (u.success) {
                if (!s.current) {
                  o('Unexpected missing auth session', new Error())
                  return
                }
                ;(Yi(s.current),
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(de, null, 'Verify your account'),
                a.createElement(
                  'div',
                  null,
                  a.createElement(
              ...
              a.createElement(
                re,
                { ariaLabel: !1, variant: 'solid', size: 'medium', onClick: () => d(i) },
                'Go to Chromatic'
              )
            )
          )
      ...
      K4 = ({ onNext: e, onUninstall: t }) =>
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(z4, null, 'Visual tests in Storybook'),
                a.createElement(
                  q,
                  { muted: !0 },
              ...
              a.createElement(
                ...
                a.createElement(q, { muted: !0, small: !0 }, 'No credit card required')
              )
            ),
            a.createElement(
              G4,
              ...
              a.createElement(
                ...
                a.createElement(
                  'div',
                  null,
                  a.createElement('span', null, 'Light mode', a.createElement(xc, { size: 10 })),
          ...
          a.createElement(
            ...
            a.createElement(xe, { onClick: () => t() }, 'Uninstall this addon')
          )
        ),
      J4 = ({ setAccessToken: e, setCreatedProjectId: t, hasProjectId: n }) => {
        let [r, i] = Se('authenticationScreen', n ? 'signin' : 'welcome'),
        ...
        if (r === 'welcome' && !n)
          return a.createElement(K4, { onNext: () => i('signin'), onUninstall: d })
        ...
        if (r === 'subdomain')
          return a.createElement(hm, { onBack: () => i('signin'), onSignIn: m })
        if (r === 'verify') {
...
`,
      ...
      bi = k.div({ width: '100%', display: 'flex', flexDirection: 'column', gap: 8 }),
      Wa = k.pre(({ theme: e }) => ({
        margin: 0,
        padding: '10px 12px',
        fontSize: '12px',
              ...
              r
                ? a.createElement(
                    ...
                    a.createElement(
                      'div',
                      null,
                      a.createElement(de, null, 'Configure your Git email'),
                      a.createElement(
                        q,
                        { center: !0, muted: !0 },
                    ...
                    a.createElement(Wa, null, 'git config user.email "you@example.com"'),
                    a.createElement(
                      q,
                      { muted: !0, small: !0 },
                      a.createElement(
                ...
                : a.createElement(
                    ...
                    a.createElement(
                      'div',
                      null,
                      a.createElement(de, null, 'Set up a Git repository'),
                      a.createElement(
                        q,
                        { center: !0, muted: !0 },
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        'li',
                        null,
                        t ? a.createElement(yi, null) : a.createElement(vi, null),
                        a.createElement(
                          bi,
                          null,
                          a.createElement('span', null, 'Initialize a Git repository'),
                          t && a.createElement(Wa, null, 'git init')
                        )
                      ),
                      a.createElement(
                        'li',
                        null,
                        n ? a.createElement(yi, null) : a.createElement(vi, null),
                        a.createElement(
                          bi,
                          null,
                          a.createElement('span', null, 'Stage all files'),
                          n && a.createElement(Wa, null, 'git add .')
                        )
                      ),
                      a.createElement(
                        'li',
                        ...
                        a.createElement(
                          ...
                          n && a.createElement(Wa, null, 'git commit -m "Initial commit"')
                        )
                      )
                    ),
                    a.createElement(
...
`),
      lp = ({ projectId: e, configFile: t, goToNext: n }) => {
        ...
        let [{ data: r, fetching: i, error: l }] = Ol({ query: ip, variables: { projectId: e } })
        return a.createElement(
          he,
          {
            footer: a.createElement(
              ...
              a.createElement(Ye, { push: !0 }, a.createElement(Vr, null))
            ),
          },
          a.createElement(
            ue,
              ...
              r?.project &&
                a.createElement(
                  ...
                  a.createElement(
                    'div',
                    null,
                    a.createElement(de, null, 'Project linked!'),
                    a.createElement(
                      q,
...
`)),
    ...
    var sp = k.div(({ theme: e }) => ({
      ...
      dp = 'https://www.chromatic.com/docs/visual-tests-addon#addon-configuration-options'
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(de, null, 'Add the project ID to your Chromatic config'),
                a.createElement(
                  q,
                  { center: !0, muted: !0 },
                  'The ',
    ...
    var up = Q.object({ message: Q.literal('createdProject'), projectId: Q.string() }),
      mp = tt(`
  query SelectProjectsQuery {
    viewer {
      accounts {
...
`),
      pp = ({ createdProjectId: e, setCreatedProjectId: t, onUpdateProject: n }) => {
        let r = a.useCallback(
          async (i) => {
            await n(i)
          },
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      Ga,
                      null,
                      a.createElement(Je, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Je, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Je, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Je, { appearance: 'secondary', isLoading: !0 }),
                      a.createElement(Je, { appearance: 'secondary', isLoading: !0 })
                    ...
                    a.createElement(
                      ...
                      r.viewer.accounts?.map((g) =>
                        a.createElement(Je, {
                          ...
                          left: a.createElement(fp, { src: g.avatarUrl ?? void 0, size: 'tiny' }),
                          onClick: () => m(g),
                          active: s === g.id,
                        })
                      )
                      ...
                      c?.projects?.map(
                        (g) =>
                          ...
                          a.createElement(Je, {
                            ...
                            key: g.id,
                            title: g.name,
                            right: a.createElement(vc, { 'aria-label': g.name }),
                            onClick: () => f(g),
                            disabled: u,
                          })
                      )
    ...
    var vp = () =>
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(de, null, "Can't connect to Chromatic"),
                a.createElement(
                  q,
                  { center: !0, muted: !0 },
                  e
      ...
      C0 = $e(w0),
      Na = () => Et(C0, 'RunBuild'),
      Ep = ({ children: e, watchState: t = w0 }) => a.createElement(C0.Provider, { value: t }, e),
      Zl = (e, t) =>
        !e?.branch || !t?.branch
          ? !1
    ...
    function Cp(e, { shouldSwitchToLastBuildOnBranch: t, lastBuildOnBranchId: n, storyId: r }) {
    ...
    var u1 = {
      ...
      S0 = ({ children: e, billingUrl: t, suspensionReason: n = 'OTHER' }) => {
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(de, null, 'Visual tests disabled for your project'),
                a.createElement(
                  q,
                  { center: !0, muted: !0 },
    ...
    var xp = x0('function'),
      Ap = (e) => e === null,
      m1 = (e) => Object.prototype.toString.call(e).slice(8, -1) === 'RegExp',
    ...
    function Ne(e, t) {
      ...
      if (e && p1(e) && t && p1(t)) {
        ...
        if (Array.isArray(e) && Array.isArray(t)) return Fp(e, t)
        if (e instanceof Map && t instanceof Map) return Mp(e, t)
        if (e instanceof Set && t instanceof Set) return Tp(e, t)
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return Np(e, t)
    ...
    var _p = [
      ...
      Ip = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']
    function Ur(e) {
    ...
    var Rp = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue']
    function _(e) {
      ...
      return _.array(e) ? 'Array' : _.plainFunction(e) ? 'Function' : Ur(e) || 'Object'
    }
    ...
    function v1(e) {
      return ([t, n]) =>
        Z.array(e)
          ? Ne(e, n) || e.some((r) => Ne(r, n) || (Z.array(n) && Rl(n)(r)))
          : Z.plainObject(e) && e[t]
            ? !!e[t] && Ne(e[t], n)
            : Ne(e, n)
    }
    ...
    function y1(e) {
      return (t) => (Z.array(e) ? e.some((n) => Ne(n, t) || (Z.array(t) && Rl(t)(n))) : Ne(e, t))
    }
    function Jn(e, t) {
      return Z.array(e) ? e.some((n) => Ne(n, t)) : Ne(e, t)
    }
    function Rl(e) {
      ...
      return {
        ...
        changed: (n, r, i) => {
          try {
            ...
            return [l, o].every(Z.array) || [l, o].every(Z.plainObject) ? !Ne(l, o) : l !== o
          } catch {
            return !1
          }
        },
        ...
        decreased: (n, r, i) => {
          if (!Z.defined(n)) return !1
          try {
            return h1(e, t, { key: n, actual: r, previous: i, type: 'decreased' })
          } catch {
            return !1
          }
        },
        ...
        increased: (n, r, i) => {
          if (!Z.defined(n)) return !1
          try {
            return h1(e, t, { key: n, actual: r, previous: i, type: 'increased' })
          } catch {
            return !1
          }
        },
    ...
    var Hp = bt(Qd(), 1),
      ...
      Ka = bt(cl(), 1),
      N = bt(ac()),
      Ma = typeof window < 'u' && typeof document < 'u' && typeof navigator < 'u',
      Dp = (function () {
    ...
    function Ta(e) {
      ...
      var t = an(e),
        ...
        r = t.overflowX,
        i = t.overflowY
      return /(auto|scroll|overlay)/.test(n + i + r) ? e : Ta(Bl(e))
    }
    function N0(e) {
      return e && e.referenceNode ? e.referenceNode : e
    }
    var E1 = Ma && !!(window.MSInputMethodContext && document.documentMode),
      k1 = Ma && /MSIE 10/.test(navigator.userAgent)
    function Bn(e) {
    ...
    function Tn(e) {
      ...
      return !r || r === 'BODY' || r === 'HTML'
        ...
        : ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) !== -1 && an(n, 'position') === 'static'
          ? Tn(n)
          : n
    }
    function Wp(e) {
    ...
    function Lr(e, t) {
      ...
      if ((e !== o && t !== o) || r.contains(i)) return Wp(o) ? o : Tn(o)
      var s = Ji(e)
      return s.host ? Lr(s.host, t) : Lr(e, Ji(t).host)
    }
    function _n(e) {
    ...
    function M0(e) {
      ...
      return { height: C1('Height', t, n, r), width: C1('Width', t, n, r) }
    }
    var Gp = function (e, t) {
    ...
    function Qi(e) {
      ...
      var i = { left: t.left, top: t.top, width: t.right - t.left, height: t.bottom - t.top },
        l = e.nodeName === 'HTML' ? M0(e.ownerDocument) : {},
      ...
      if (d || c) {
        var m = an(e)
        ;((d -= w1(m, 'x')), (c -= w1(m, 'y')), (i.width -= d), (i.height -= c))
      }
      return Zt(i)
    }
    function Pl(e, t) {
      ...
      return ((r && !n ? t.contains(s) : t === s && s.nodeName !== 'BODY') && (u = qp(u, t)), u)
    }
    function Kp(e) {
    ...
    function _0(e) {
      ...
      for (var t = e.parentElement; t && an(t, 'transform') === 'none'; ) t = t.parentElement
    ...
    function Vl(e, t, n, r) {
      ...
      if (r === 'viewport') l = Kp(o, i)
        ...
        var s = void 0
        r === 'scrollParent'
          ? ((s = Ta(Bl(t))), s.nodeName === 'BODY' && (s = e.ownerDocument.documentElement))
          : r === 'window'
            ? (s = e.ownerDocument.documentElement)
            : (s = r)
        var d = Pl(s, o, i)
        if (s.nodeName === 'HTML' && !T0(o)) {
          var c = M0(e.ownerDocument),
            m = c.height,
            u = c.width
    ...
    function I0(e, t, n, r, i) {
      ...
      var o = Vl(n, r, l, i),
        ...
        d = Object.keys(s)
          .map(function (p) {
            return qe({ key: p }, s[p], { area: Jp(s[p]) })
          })
          .sort(function (p, f) {
    ...
    function B0(e, t, n) {
      var r = n === void 0 ? e : e.slice(0, Qp(e, 'name', n))
      return (
    ...
    function Xp() {
      if (!this.state.isDestroyed) {
        ...
        ;((e.offsets.reference = O0(
          ...
          (e.offsets.popper = R0(this.popper, e.offsets.reference, e.placement)),
    ...
    function H0(e, t, n, r) {
      ...
      ;(l.addEventListener(t, n, { passive: !0 }), i || H0(Ta(l.parentNode), t, n, r), r.push(l))
    }
    function t3(e, t, n, r) {
    ...
    function n3() {
      this.state.eventsEnabled ||
        (this.state = t3(this.reference, this.options, this.state, this.scheduleUpdate))
    }
    function a3(e, t) {
      return (
    ...
    function r3() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = a3(this.reference, this.state)))
    }
    function Dl(e) {
    ...
    function l3(e) {
      return (
        ...
        e.arrowElement && Object.keys(e.arrowStyles).length && Xi(e.arrowElement, e.arrowStyles),
        e
      )
    }
    ...
    var d3 = Ma && /Firefox/i.test(navigator.userAgent)
    function c3(e, t) {
      var n = t.x,
        r = t.y,
        i = e.offsets.popper,
    ...
    function u3(e, t) {
      ...
      return (
        ...
        (e.arrowElement = r),
        (e.offsets.arrow = ((n = {}), In(n, u, Math.round(v)), In(n, p, ''), n)),
        e
      )
    }
    function m3(e) {
        ...
        o.forEach(function (s, d) {
          ...
          ;(p || b || S) &&
            ...
            (e.offsets.popper = qe(
              {},
              e.offsets.popper,
              R0(e.instance.popper, e.offsets.reference, e.placement)
            )),
    ...
    function y3(e, t) {
      ...
      var r = Hl('transform'),
        ...
        s = i[r]
      ;((i.top = ''), (i.left = ''), (i[r] = ''))
      var d = Vl(e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed)
      ...
      var c = t.priority,
        ...
        u = {
          primary: function (p) {
            var f = m[p]
            return (
              m[p] < d[p] && !t.escapeWithReference && (f = Math.max(m[p], d[p])),
              In({}, p, f)
            )
          },
          secondary: function (p) {
            ...
            return (
              m[p] > d[p] &&
                ...
                (h = Math.min(m[f], d[p] - (p === 'right' ? m.width : m.height))),
              In({}, f, h)
            )
          },
        }
    ...
    function b3(e) {
      ...
      if (r) {
        var i = e.offsets,
          ...
          d = s ? 'left' : 'top',
          c = s ? 'width' : 'height',
          m = { start: In({}, d, l[d]), end: In({}, d, l[d] + l[c] - o[c]) }
    ...
    var w3 = {
        ...
        applyStyle: { order: 900, enabled: !0, fn: l3, onLoad: o3, gpuAcceleration: void 0 },
      },
      C3 = {
        placement: 'bottom',
        positionFixed: !1,
        ...
        function e(t, n) {
          ...
          ;(Gp(this, e),
            ...
            this.modifiers.forEach(function (o) {
              o.enabled && F0(o.onLoad) && o.onLoad(r.reference, r.popper, r.options, o, r.state)
            }),
            this.update())
    ...
    I.object = function (e) {
      return !I.nullOrUndefined(e) && (I.function(e) || typeof e == 'object')
    }
    ...
    var N3 = z0('function'),
      ...
      L1 = function (e) {
        return !T3(e) && !M3(e) && (N3(e) || typeof e == 'object')
      },
      T3 = z0('undefined'),
      tl = function (e) {
    ...
    function O3(e, t) {
      ...
      if (e.size !== t.size) return !1
      try {
        for (var o = tl(e.entries()), s = o.next(); !s.done; s = o.next()) {
          var d = s.value
      ...
      try {
        for (var c = tl(e.entries()), m = c.next(); !m.done; m = c.next()) {
          var d = m.value
    ...
    function Z3(e, t) {
      ...
      if (e.size !== t.size) return !1
      try {
        for (var i = tl(e.entries()), l = i.next(); !l.done; l = i.next()) {
          var o = l.value
    ...
    function Be(e, t) {
      ...
      if (e && L1(e) && t && L1(t)) {
        ...
        for (var i = n.length; i-- !== 0; ) {
          var l = n[i]
          if (!(l === '_owner' && e.$$typeof) && !Be(e[l], t[l])) return !1
        }
        return !0
      }
      return Number.isNaN(e) && Number.isNaN(t) ? !0 : e === t
    }
    var R3 = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue'],
      B3 = [
        'Array',
        'ArrayBuffer',
        'AsyncFunction',
      ...
      P3 = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']
    function qr(e) {
      var t = Object.prototype.toString.call(e).slice(8, -1)
      if (/HTML\w+Element/.test(t)) return 'HTMLElement'
      if (V3(t)) return t
      ...
      return U0(e, t)
        ? [e, t].every(W.array)
          ...
          : [e, t].every(W.plainObject)
            ? !Object.entries(e).some(T1(n)) && Object.entries(t).some(T1(n))
            : t === n
        : !1
    }
    function F1(e, t, n) {
      var r = n.actual,
        ...
        s = ht(e, i),
        d = ht(t, i),
        c = [s, d].every(W.number) && (o === 'increased' ? s < d : s > d)
      return (W.undefined(r) || (c = c && d === r), W.undefined(l) || (c = c && s === l), c)
    }
    function N1(e, t, n) {
      var r = n.key,
        i = n.type,
      ...
      return [o, s].every(W.array)
        ...
        : [o, s].every(W.plainObject)
          ...
          : ![o, s].every(function (m) {
            ...
            }) && (i === 'added' ? !W.defined(o) && W.defined(s) : W.defined(o) && !W.defined(s))
    }
    function M1(e, t, n) {
      var r = n === void 0 ? {} : n,
        i = r.key,
      ...
      return ([l, o].every(W.plainObject) && ((l = Object.keys(l)), (o = Object.keys(o))), [l, o])
    }
    function T1(e) {
      return function (t) {
        var n = t[0],
    ...
    function U0() {
      for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t]
      return e.every(W.array) || e.every(W.number) || e.every(W.plainObject) || e.every(W.string)
    }
    function ht(e, t) {
    ...
    function U3(e, t) {
      if ([e, t].some(W.nullOrUndefined)) throw new Error('Missing required parameters')
      if (
      ...
      var n = function (u, p) {
          try {
            return N1(e, t, { key: u, type: 'added', value: p })
          } catch {
            return !1
          }
        },
        r = function (u, p, f) {
          try {
            var h = ht(e, u),
              ...
              b = W.defined(f)
            if (w || b) {
              var g = b ? Qn(f, h) : !Qn(p, h),
                v = Qn(p, y)
              return g && v
            }
            return [h, y].every(W.array) || [h, y].every(W.plainObject) ? !Be(h, y) : h !== y
          } catch {
            return !1
          }
        },
        ...
        o = function (u, p, f) {
          if (!W.defined(u)) return !1
          try {
            return F1(e, t, { key: u, actual: p, previous: f, type: 'decreased' })
          } catch {
            return !1
          }
        },
        ...
        c = function (u, p, f) {
          if (!W.defined(u)) return !1
          try {
            return F1(e, t, { key: u, actual: p, previous: f, type: 'increased' })
          } catch {
            return !1
          }
        },
        m = function (u, p) {
          try {
            return N1(e, t, { key: u, type: 'removed', value: p })
          } catch {
            return !1
          }
        }
    ...
    var Y3 = { flip: { padding: 20 }, preventOverflow: { padding: 10 } },
      ...
      J3 = 'The error message is optional, but must be a string if provided.'
    function Q3(e, t, n, r) {
    ...
    function th(e, t) {
      ...
      if (t && typeof t != 'string') throw new TypeError(J3)
    }
    function Z1(e, t, n) {
      return (
        th(e, n),
        ...
        Oa(n, [
          {
            ...
            value: function () {
              dt() && (this.node || this.appendNode(), Xn || this.renderPortal())
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              var r = this.props,
                i = r.children,
                l = r.setRef
              if ((this.node || this.appendNode(), Xn)) return qn.createPortal(i, this.node)
    ...
    Y0.propTypes = { handleClick: N.default.func.isRequired, styles: N.default.object.isRequired }
    function K0(e) {
      var t = e.content,
        n = e.footer,
        r = e.handleClick,
      ...
      return (
        ...
        (o || l) &&
          !We.boolean(i) &&
          (c.close = a.createElement(Y0, { styles: d.close, handleClick: r })),
        a.createElement(
          'div',
        ...
        Oa(n, [
          {
            ...
            get: function () {
              ...
              return (
                ...
                [ie.OPENING, ie.OPEN].indexOf(d) !== -1 && (b = pe(pe({}, b), h)),
            ...
            value: function () {
              ...
              return (
                i
                  ...
                  : (c.content = a.createElement(K0, this.props)),
                d === ie.OPEN && m.push('__floater__open'),
                o || (c.arrow = a.createElement(G0, this.props)),
                a.createElement(
                  'div',
              ...
              if (i)
                if (a.Children.count(i) === 1)
                  if (!a.isValidElement(i)) p = a.createElement('span', null, i)
                    ...
                    var f = We.function(i.type) ? 'innerRef' : 'ref'
                    p = a.cloneElement(a.Children.only(i), Ce({}, f, d))
                  }
                else p = i
              return p
                ? a.createElement(
          ...
          return (
            ...
            Ce(Ct(i), 'handleTransitionEnd', function () {
              ...
              ;(i.wrapperPopper && i.wrapperPopper.instance.update(),
                i.setState({ status: l === ie.OPENING ? ie.OPEN : ie.IDLE }, function () {
                  var s = i.state.status
                  o(s === ie.OPEN ? 'open' : 'close', i.props)
                }))
            }),
            Ce(Ct(i), 'handleClick', function () {
              ...
              if (!We.boolean(s)) {
                ...
                ;(i.event === 'click' || (i.event === 'hover' && c)) &&
                  (Ja({
                    title: 'click',
                    data: [{ event: o, status: m === ie.OPEN ? 'closing' : 'opening' }],
                    debug: i.debug,
                  }),
                  i.toggle())
              }
            ...
            Ce(Ct(i), 'handleMouseLeave', function () {
              ...
              if (!(We.boolean(d) || Ci())) {
                ...
                i.event === 'hover' &&
                  ...
                  s
                    ? [ie.OPENING, ie.OPEN].indexOf(m) !== -1 &&
                      !u &&
                      !i.eventDelayTimeout &&
          ...
          Oa(n, [
            ...
            },
            {
              ...
              value: function (r, i) {
                if (dt()) {
                  ...
                  if (r.open !== s) {
                    var f
                    ;(We.boolean(s) && (f = s ? ie.OPENING : ie.CLOSING), this.toggle(f))
                  }
                  ;((r.wrapperOptions.position !== c.position || r.target !== d) &&
                    this.changeWrapperPosition(this.props),
                    p('status', ie.IDLE) && s
                      ? this.toggle(ie.OPEN)
                      : u('status', ie.INIT, ie.IDLE) && o && this.toggle(ie.OPEN),
                    this.popper && p('status', ie.OPENING) && this.popper.instance.update(),
                    this.floaterRef &&
                      (p('status', ie.OPENING) || p('status', ie.CLOSING)) &&
                      rh(this.floaterRef, 'transitionend', this.handleTransitionEnd),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (u === 'center') this.setState({ status: ie.IDLE })
                  ...
                  new x1(i, this.floaterRef, {
                    ...
                    modifiers: pe(
                      {
                        arrow: pe({ enabled: !c, element: this.arrowRef }, y),
                        flip: pe({ enabled: !s, behavior: f }, w),
                    ...
                    onCreate: function (E) {
                      ...
                      ;(d(E, 'floater'),
                        r._isMounted &&
                          r.setState({ currentPlacement: E.placement, status: ie.IDLE }),
                        u !== E.placement &&
                          setTimeout(function () {
                            E.instance.update()
                          }, 1))
                ...
                if (l) {
                  var v = We.undefined(p.offset) ? 0 : p.offset
                  new x1(this.target, this.wrapperRef, {
                    ...
                    onCreate: function (E) {
                      ;((r.wrapperPopper = E),
                        r._isMounted && r.setState({ statusWrapper: ie.IDLE }),
                        d(E, 'wrapper'),
                        u !== E.placement &&
                          setTimeout(function () {
                            E.instance.update()
            ...
            },
            {
              ...
              value: function (r) {
                ...
                ;(We.undefined(r) || (l = r), this.setState({ status: l }))
              },
            },
            {
              key: 'debug',
            ...
            },
            {
              ...
              get: function () {
                ...
                if (o) {
                  var m
                  ;([ie.IDLE].indexOf(l) === -1 || [ie.IDLE].indexOf(s) === -1
                    ? (m = c.wrapperPosition)
    ...
    Ce(zl, 'propTypes', {
      ...
      children: N.default.node,
      component: Z1(N.default.oneOfType([N.default.func, N.default.element]), function (e) {
        return !e.content
      }),
      content: Z1(N.default.node, function (e) {
        return !e.component
      }),
    ...
    function gh(e, t, n) {
      ...
      if (d && c) {
        ...
        s instanceof HTMLElement &&
          ((m = s.scrollTop), !d && !On(e) && (u += m), s.isSameNode(qt()) || (u += qt().scrollTop))
      return Math.floor(u - t)
    }
    function vh(e, t, n) {
      var r
      if (!e) return 0
      let { offsetTop: i = 0, scrollTop: l = 0 } = (r = (0, L0.default)(e)) != null ? r : {},
    ...
    function ct(e, t = {}) {
      ...
      else if (Xr(e) && !Object.values(e.props).length && or(e.type) === 'function') {
        let o = e.type({})
        l = ct(o, t)
    ...
    function al(e, t, n) {
      ...
      if (or(i) === 'string' && i.includes('{step}')) return Qr(e, { children: r(i) })
      if (Array.isArray(i))
        return Qr(e, { children: i.map((l) => (typeof l == 'string' ? r(l) : al(l, t, n))) })
    ...
    function Fh(e, t) {
      ...
      let { floaterProps: s, styles: d } = e,
        c = (0, Ka.default)((n = t.floaterProps) != null ? n : {}, s ?? {}),
      ...
      let h = {
        ...
        y = {
          ...
          buttonNext: { ...ta, backgroundColor: u.primaryColor, borderRadius: 4, color: '#fff' },
          buttonBack: { ...ta, color: u.primaryColor, marginLeft: 'auto', marginRight: 5 },
          buttonClose: {
            ...ta,
            color: u.textColor,
            height: 14,
    ...
    function pn(e, t) {
      var n, r, i, l, o, s
      let d = t ?? {},
        c = Ya.default.all([xh, Nh(e), d], { isMergeableObject: Z.plainObject }),
        m = Fh(e, c),
      ...
      return (
        (p.offset = c.offset),
        (p.styles = (0, Ya.default)((i = p.styles) != null ? i : {}, m.floaterStyles)),
        (p.offset +=
        ...
        {
          ...c,
          locale: Ya.default.all([nd, (s = e.locale) != null ? s : {}, c.locale || {}]),
          floaterProps: p,
      ...
      Mh = class {
          ...
          ;(R(this, 'beaconPopper'),
            ...
            R(this, 'setSteps', (i) => {
              ...
              ;(this.data.set('steps', i),
                o === ne.WAITING && !l && i.length && (s.status = ne.RUNNING),
                this.setState(s))
            }),
            ...
            R(this, 'close', (i = null) => {
              ...
              o === ne.RUNNING &&
                this.setState({
                  ...this.getNextState({ action: se.CLOSE, index: l + 1, origin: i }),
                })
            }),
            R(this, 'go', (i) => {
              ...
              this.setState({
                ...this.getNextState({ action: se.GO, index: i }),
            ...
            R(this, 'next', () => {
              ...
              l === ne.RUNNING &&
                this.setState(this.getNextState({ action: se.NEXT, index: i + 1 }))
            }),
            R(this, 'open', () => {
              let { status: i } = this.getState()
              i === ne.RUNNING &&
                this.setState({ ...this.getNextState({ action: se.UPDATE, lifecycle: K.TOOLTIP }) })
            }),
            R(this, 'prev', () => {
              let { index: i, status: l } = this.getState()
              l === ne.RUNNING &&
                this.setState({ ...this.getNextState({ action: se.PREV, index: i - 1 }) })
            }),
            R(this, 'reset', (i = !1) => {
              let { controlled: l } = this.getState()
              l ||
                this.setState({
                  ...this.getNextState({ action: se.RESET, index: 0 }),
            ...
            R(this, 'skip', () => {
              let { status: i } = this.getState()
              i === ne.RUNNING &&
                this.setState({ action: se.SKIP, lifecycle: K.INIT, status: ne.SKIPPED })
            }),
            R(this, 'start', (i) => {
              let { index: l, size: o } = this.getState()
              this.setState({
                ...this.getNextState({ action: se.START, index: Z.number(i) ? i : l }, !0),
            ...
            R(this, 'stop', (i = !1) => {
              ...
              ;[ne.FINISHED, ne.SKIPPED].includes(o) ||
                this.setState({
                  ...this.getNextState({ action: se.STOP, index: l + (i ? 1 : 0) }),
                  status: ne.PAUSED,
                })
            }),
            R(this, 'update', (i) => {
              var l, o
              if (!bh(i, D1)) throw new Error(`State is not valid. Valid keys: ${D1.join(', ')}`)
              this.setState({
                ...this.getNextState(
                  {
                    ...this.getState(),
                    ...i,
                    action: (l = i.action) != null ? l : se.UPDATE,
        ...
        getNextState(e, t = !1) {
          ...
          return {
            ...
            status: f === m ? ne.FINISHED : (o = e.status) != null ? o : u,
          }
        }
        getSteps() {
      ...
      Oh = class extends Dt {
          ...
          ;(o('lifecycle', K.TOOLTIP) &&
            ...
            (o('spotlightClicks') || o('disableOverlay') || o('lifecycle')) &&
              (i && r === K.TOOLTIP
                ...
                : r !== K.TOOLTIP && window.removeEventListener('mousemove', this.handleMouseMove)))
        }
        ...
        get overlayStyles() {
          let { mouseOverSpotlight: e } = this.state,
            ...
            i = r.overlay
          return (
            P1() && (i = n === 'center' ? r.overlayLegacyCenter : r.overlayLegacy),
            {
    ...
    function Hh(e) {
      ...
      return (
        ...
        (w.close = !u && C(Vh, { 'data-test-id': 'button-close', styles: h.buttonClose, ...n })),
        C(
          'div',
          {
            key: 'JoyrideTooltip',
          ...
          C(
            ...
            y && C('h1', { 'aria-label': ct(y), style: h.tooltipTitle }, y),
      ...
      zh = class extends Dt {
        ...
        componentDidUpdate(e) {
          ...
          let {
            ...
            g = h('action') || h('index') || h('lifecycle') || h('status'),
          ...
          if (
            (E &&
              (v || S) &&
              r({ ...w, index: e.index, lifecycle: K.COMPLETE, step: e.step, type: Qe.STEP_AFTER }),
            p.placement === 'center' &&
              u === ne.RUNNING &&
              h('index') &&
              n !== se.START &&
            ...
            let L = xt(p.target),
              F = !!L
            F && fh(L)
              ? (y('status', ne.READY, ne.RUNNING) || y('lifecycle', K.INIT, K.READY)) &&
                r({ ...w, step: p, type: Qe.STEP_BEFORE })
              : (console.warn(F ? 'Target not visible' : 'Target not mounted', p),
                r({ ...w, type: Qe.TARGET_NOT_FOUND, step: p }),
                l || f.update({ index: d + (n === se.PREV ? -1 : 1) }))
          }
          ;(y('lifecycle', K.INIT, K.READY) &&
            f.update({ lifecycle: B1(p) || b ? K.TOOLTIP : K.BEACON }),
            h('index') &&
              nn({ title: `step:${c}`, data: [{ key: 'props', value: this.props }], debug: o }),
            h('lifecycle', K.BEACON) && r({ ...w, step: p, type: Qe.BEACON }),
            h('lifecycle', K.TOOLTIP) &&
              (r({ ...w, step: p, type: Qe.TOOLTIP }),
              m &&
                this.tooltip &&
                ((this.scope = new Rh(this.tooltip, { selector: '[data-action=primary]' })),
                this.scope.setFocus())),
      ...
      id = class extends Dt {
          ...
          ;(super(e),
            ...
            R(this, 'handleClickOverlay', () => {
              let { index: o } = this.state,
                { steps: s } = this.props
              pn(this.props, s[o]).disableOverlayClose || this.helpers.close('overlay')
            }),
            R(this, 'syncState', (o) => {
              this.setState(o)
            }))
          let { debug: t, getHelpers: n, run: r = !0, stepIndex: i } = e
          ;((this.store = Th({ ...e, controlled: r && Z.number(i) })),
        ...
        componentDidUpdate(e, t) {
          ...
          let { action: n, controlled: r, index: i, status: l } = this.state,
            ...
            { reset: p, setSteps: f, start: h, stop: y, update: w } = this.store,
            ...
            F = xt(E.target)
          if (
            (S && (H1(c, o) ? f(c) : console.warn('Steps are not valid', c)),
            b('run') && (s ? h(d) : y()),
            L)
          ) {
            ...
            ;(n === se.STOP && (te = se.START),
              [ne.FINISHED, ne.SKIPPED].includes(l) ||
                w({ action: n === se.CLOSE ? se.CLOSE : te, index: d, lifecycle: K.INIT }))
          }
          !r &&
            l === ne.RUNNING &&
            i === 0 &&
            ...
            this.callback({ ...this.state, type: Qe.TARGET_NOT_FOUND, step: E }))
          let G = { ...this.state, index: i, step: E }
          if (g('action', [se.NEXT, se.PREV, se.SKIP, se.CLOSE]) && g('status', ne.PAUSED)) {
          ...
          if (g('status', [ne.FINISHED, ne.SKIPPED])) {
            ...
            ;(r ||
              ...
              this.callback({ ...G, type: Qe.TOUR_END, step: te, index: t.index }),
              p())
          } else
            v('status', [ne.IDLE, ne.READY], ne.RUNNING)
              ? this.callback({ ...G, type: Qe.TOUR_START })
              : (g('status') || g('action', se.RESET)) &&
                this.callback({ ...G, type: Qe.TOUR_STATUS })
          this.scrollToStep(t)
        }
        componentWillUnmount() {
        ...
        scrollToStep(e) {
          ...
          if (r === ne.RUNNING && p) {
            ...
            if (n === K.BEACON && w) {
              ...
              !['bottom'].includes(v) && !f && (y = Math.floor(g.popper.top - s))
            ...
            ;((y = y >= 0 ? y : 0),
              r === ne.RUNNING &&
                yh(y, { element: h, duration: o }).then(() => {
                  setTimeout(() => {
                    var g
                    ;(g = this.store.getPopper('tooltip')) == null || g.instance.update()
                  }, 10)
                }))
          }
        }
    ...
    var Uh = id,
      ...
      Mr = ([e, ...t]) => t.reduce((n, r) => (j1.indexOf(r) > j1.indexOf(n) ? r : n), e)
    function $h(e) {
      return (e.FAILED ?? 0) > 0
        ? 'FAILED'
        : (e.IN_PROGRESS ?? 0) > 0
      ...
      let {
          ...
          (u, p) => (
            ...
            p.comparisons?.forEach(({ browser: f, result: h }) => {
              u.resultsByBrowser[f.id] = Mr([h ?? void 0, u.resultsByBrowser[f.id]])
            }),
            p.comparisons?.forEach(({ result: f }) => {
              u.resultsByMode[p.mode.name] = Mr([f ?? void 0, u.resultsByMode[p.mode.name]])
            }),
    ...
    var Wh = (e) => {
      ...
      ld = ({ result: e }) => e && !['EQUAL', 'FIXED', 'SKIPPED'].includes(e),
      qh = (e, t) => {
    ...
    function Yh(e) {
      ...
      return (
        e.length &&
          ((d = t ? qh(e, i) : e.find(({ mode: m }) => m.name === i) || e[0]),
          (c = t
            ? Gh(d.comparisons, o)
...
`),
      n7 = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        ...
        let d = o && t && o.variables.storyId !== t,
          c = bn(Jh, i?.project?.lastBuildOnBranch),
          m = [
            ...bn(Xh, c && 'testsForStory' in c && c.testsForStory ? c.testsForStory.nodes : []),
          ],
          u = c?.committedAt > n.committedAt,
          p = !!c && !u,
          f = !!c && m.every((y) => y.status !== 'IN_PROGRESS'),
          h = bn(Qh, i?.selectedBuild ?? (f ? i?.project?.lastBuildOnBranch : void 0))
        return {
      ...
      Si = ({ children: e, watchState: t }) => {
        let n = !!t?.selectedBuild && 'testsForStory' in t.selectedBuild,
          ...
          { toggleDiff: o } = La()
        return (
          J(() => o(l.changeCount > 0), [o, l.changeCount]),
          a.createElement(
            $l.Provider,
            { value: kt(() => t, [JSON.stringify(t?.selectedBuild)]) },
            a.createElement(
              sd.Provider,
              { value: { hasTests: n, tests: i, summary: l, ...Yh(i) } },
              e
            )
          )
        )
      ...
      o7 = k.div({ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }),
      s7 = k.div(({ theme: e }) => ({
        fontSize: 13,
        lineHeight: '18px',
        fontWeight: 700,
      ...
      c7 = k.div({ display: 'flex', justifyContent: 'flex-end', marginTop: 15 }),
      ...
      z1 = 'setFilter',
      m7 = ({ managerApi: e, skipWalkthrough: t, startWalkthrough: n, completeWalkthrough: r }) => {
        let i = un(),
          l = rn(),
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              {
                target: '_blank',
                href: e.errorDetailsUrl || `${ws}#troubleshooting`,
                withArrow: !0,
              },
    ...
    function U1(e, t) {
      let n = t?.round ?? 1
      if (!Number.isFinite(e) || e <= 0) return { value: 0, symbol: na[0], exponent: 0 }
      let r = Math.min(na.length - 1, Math.max(0, Math.floor(Math.log10(e) / 3))),
      ...
      Wl = {
        ...
        upload: {
          ...
          renderProgress: ({ stepProgress: e }) => {
            ...
            if (n == null || t == null || n <= 0) return 'Uploading files...'
            let { value: r, exponent: i } = U1(n, { round: 1 }),
              { value: l, symbol: o } = U1(t, { exponent: i, round: 1 })
    ...
    var ud = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
      ...
      v7 = k(q)({ display: 'flex', flexDirection: 'column', gap: 10, width: 200, marginTop: 15 }),
      md = k.div(({ theme: e }) => ({
        height: 5,
        background: e.background.hoverable,
        borderRadius: 5,
    ...
    function Yr({ localBuildProgress: e }) {
      return a.createElement(
        ...
        a.createElement(ud, { center: !0, muted: !0, small: !0, localBuildProgress: e })
      )
    }
    var b7 =
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(de, null, 'Make a change to this story'),
                a.createElement(
                  q,
              ...
              a.createElement(
                ...
                t
                  ...
                  : a.createElement(C7, null, 'Awaiting changes...'),
                a.createElement(re, { ariaLabel: !1, link: !0, onClick: e }, 'Skip walkthrough')
              )
            )
          )
        ),
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                null,
                a.createElement(de, null, 'Running your first test'),
                a.createElement(
                  q,
                  { center: !0, muted: !0 },
      ...
      N7 = ({ isUnchanged: e, localBuildProgress: t, ...n }) => (
            ...
            n
              ? a.createElement(
                  ...
                  a.createElement(
                    'div',
                    null,
                    a.createElement(de, null, 'Nice. Your stories were saved as test baselines.'),
                    a.createElement(
                      q,
                      { center: !0, muted: !0, block: !0 },
                  ...
                  a.createElement(
                    Ft,
                    null,
                    a.createElement($1, null, "You're ready to start testing!"),
                    a.createElement(
                      re,
                      { ariaLabel: !1, variant: 'solid', size: 'medium', onClick: e },
                      'Done'
                    ),
                    a.createElement(re, { ariaLabel: !1, link: !0, onClick: t }, 'Skip walkthrough')
                  )
                )
              : a.createElement(
                  oe,
                  ...
                  a.createElement(
                    'div',
                    null,
                    a.createElement(de, null, 'Nice. You ran your first tests!'),
                    a.createElement(
                      q,
                      { center: !0, muted: !0, block: !0 },
                  ...
                  a.createElement(
                    Ft,
                    null,
                    a.createElement($1, null, "It's time to review changes!"),
                    a.createElement(
                      re,
                      { ariaLabel: !1, variant: 'solid', size: 'medium', onClick: e },
                      'Take a tour'
      ...
      q1 = () =>
        a.createElement(
          'div',
          null,
          a.createElement(de, null, 'Get started with visual testing'),
          a.createElement(
            q,
            { center: !0, muted: !0 },
      ...
      _7 = ({ isRunning: e, localBuildProgress: t, startBuild: n, onSkip: r }) => (
          ...
          a.createElement(
            ...
            t
              ? a.createElement(
                  ...
                  a.createElement(Yr, { localBuildProgress: t })
                )
              : a.createElement(
                  oe,
                  null,
                  ...
                  a.createElement(
                    ...
                    a.createElement(re, { ariaLabel: !1, link: !0, onClick: r }, 'Skip walkthrough')
                  )
                )
          )
        )
      ...
      Z7 = ({
        ...
        let { isRunning: s, startBuild: d } = Na(),
        ...
        return t?.currentStep === 'error'
          ? a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(re, { ariaLabel: !1, link: !0, onClick: o }, 'Skip walkthrough')
              )
            )
          : t?.currentStep === 'limited'
            ? a.createElement(
                ...
                a.createElement(re, { ariaLabel: !1, link: !0, onClick: e }, 'Continue')
              )
            : c && (!t || (t && s))
              ? a.createElement(_7, {
                  isRunning: s,
              ...
              : t?.currentStep === 'complete' && !u && !w
                ? i
                  ...
                  : a.createElement(O7, { onCatchAChange: y, onSkip: o })
                : u && !i
                  ? a.createElement(N7, {
                      isRunning: s,
                  ...
                  : i
                    ? a.createElement(W1, { onComplete: l, onSkip: o, ranSecondBuild: u && w })
                    : null
      },
      R7 = k.div(({ theme: e }) => ({
      ...
      B7 = Mt({ from: { transform: 'rotate(0deg)' }, to: { transform: 'rotate(359deg)' } }),
      P7 = k(fs)({ animation: `${B7} 1s linear infinite` }),
      Qa = { width: 10, marginRight: 8 },
      ...
      j7 = k.div(({ isCurrent: e, isFailed: t, isPending: n, theme: r }) => ({
        display: 'flex',
        flexDirection: 'row',
        gap: 8,
        opacity: n ? 0.7 : 1,
        ...
        let r = ['aborted', 'error'].includes(e.currentStep),
          i = rl.map((l) => {
            let { startedAt: o, completedAt: s } = e.stepProgress[l],
              ...
              c = d && r,
              m = !o,
              u = { ...Wl[l], isCurrent: d, isFailed: c, isPending: m }
            return c
              ? { ...u, icon: a.createElement(Jt, { style: Qa }), renderLabel: u.renderProgress }
              : d
                ? { ...u, icon: a.createElement(P7, { style: Qa }), renderLabel: u.renderProgress }
                : m
                  ? { ...u, icon: a.createElement(Ac, { style: Qa }), renderLabel: u.renderName }
                  : {
                      ...u,
                      icon: a.createElement(Zr, { style: Qa }),
      ...
      U7 = ({
        ...
        if (n) {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(Y1, { percentage: n.buildProgressPercentage, isWarning: u }),
              a.createElement(
                Xa,
                null,
                a.createElement(ud, { localBuildProgress: n, withEmoji: !0 })
              ),
              m
                ? a.createElement(
                    V.Button,
                ...
                : a.createElement(
                    ...
                    a.createElement(V7, { style: { transform: `rotate(${l ? -180 : 0}deg)` } })
                  )
            ),
            a.createElement(z7, { localBuildProgress: n, expanded: l || m })
          )
        }
        function d() {
          return i
        ...
        return a.createElement(G1, { onClick: i }, a.createElement(Y1, { percentage: 100 }), d())
      },
      pd = {
        isReviewing: !1,
        userCanReview: !1,
      ...
      hd = $e(pd),
      fd = () => Et(hd, 'ReviewTest'),
      $7 = ({ children: e, watchState: t = pd }) => a.createElement(hd.Provider, { value: t }, e),
      W7 = k.div(
        ({ theme: e }) => ({
          position: 'relative',
          display: 'flex',
      ...
      Y7 = ({
        ...
        let p = un(),
          ...
          h = r === 'CAPTURE_ERROR',
          y = f && !!d,
          w = f ? { as: 'a', href: n, target: '_blank', title: 'View on Chromatic.com' } : {},
          b = f && c,
          g = y && m,
          [v, E] = a.useState(!1),
          [S, L] = a.useState(!1),
          ...
          [te, fe] = a.useState(!1),
          ke = o ? S : v,
          je = G7({ comparisonImageLoaded: F, focusImageLoaded: te, showDiff: b, showFocus: g })
        return a.createElement(
          W7,
          { ...u, ...w },
          i &&
          ...
          h &&
            ...
            a.createElement(
              q7,
              null,
              a.createElement(rc, { color: p.base === 'light' ? 'currentColor' : p.color.medium }),
              a.createElement(
                q,
                { center: !0, muted: !0 },
      ...
      yd = ({ status: e, children: t }) =>
        a.createElement(J7, null, t, a.createElement(gd, { overlay: !0, status: e })),
      J1 = {
      ...
      Q7 = k(V.Text)(({ theme: e, active: t }) => ({
        minWidth: 80,
        color: t ? e.color.secondary : 'inherit',
        fontWeight: t ? e.typography.weight.bold : 'inherit',
      })),
      X7 = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        let i = Mr(n.map(({ result: s }) => s))
        if (!i) return null
        let l = J1[t.key]
        if (
          (!e &&
        ...
        let o = n.map(({ browser: s, result: d }) => ({
          ...
          title: s.name,
          icon: J1[s.key],
          right: !e && !['EQUAL', 'SKIPPED'].includes(i) && a.createElement(vd, { status: d }),
          onClick: () => r(s),
                ...
                o.map((d) =>
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(Q7, { active: d.active }, d.title),
      ...
      t6 = ({ isAccepted: e, modeOrder: t, modeResults: n, onSelectMode: r, selectedMode: i }) => {
        ...
        let s = n
          .map(({ mode: d, result: c }) => ({
            id: d.name,
            title: d.name,
            right: !e && !['EQUAL', 'SKIPPED'].includes(l) && a.createElement(vd, { status: c }),
            onClick: () => r(d),
                ...
                s.map((c) =>
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(e6, { active: c.active }, c.title),
      ...
      r6 = ({ isOutdated: e }) => {
        let { baselineImageVisible: t, diffVisible: n, focusVisible: r } = xl(),
          { toggleBaselineImage: i, toggleDiff: l, toggleFocus: o } = La(),
          { isRunning: s, startBuild: d } = Na(),
          { selectedTest: c, selectedComparison: m, summary: u } = rn(),
      ...
      Ai = { width: 12, height: 12, margin: '3px 3px 3px 6px', verticalAlign: 'top' },
      l6 = ({ icon: e }) => {
        let { color: t } = un()
        return {
          passed: a.createElement(yc, { style: { ...Ai, color: t.positive } }),
          changed: a.createElement(bc, { style: { ...Ai, color: t.warning } }),
          failed: a.createElement(Jt, { style: { ...Ai, color: t.negative } }),
        }[e]
      }
    function ll(e) {
    ...
    var f6 = {
      ...
      g6 = { full: 'h:mm:ss a zzzz', long: 'h:mm:ss a z', medium: 'h:mm:ss a', short: 'h:mm a' },
      v6 = {
        full: "{{date}} 'at' {{time}}",
        long: "{{date}} 'at' {{time}}",
        medium: '{{date}}, {{time}}',
    ...
    var Z6 = /^(\d+)(th|st|nd|rd)?/i,
      ...
      P6 = { any: [/^b/i, /^(a|c)/i] },
      V6 = { narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i },
    ...
    function Q6(e, t, n) {
      ...
      var c = Ed(J6(n), { addSuffix: !!n?.addSuffix, comparison: d }),
        m,
        u
    ...
    function X6(e, t) {
      return (Ba(1, arguments), Q6(e, Date.now(), t))
    }
    var ef = {
    ...
    var kd = (e) => X6(e, { addSuffix: !0, locale: { ...bd, formatDistance: tf } }),
      ia = k.div(({ theme: e }) => ({
        gridArea: 'info',
        display: 'flex',
        justifySelf: 'start',
  ...
  `,
      ...
      ds = k.div({ gridArea: 'footer', position: 'sticky', zIndex: 1, bottom: 0 }),
      ...
      sf = ({
        ...
        let { baselineImageVisible: s, diffVisible: d, focusVisible: c } = xl(),
          ...
          E = h.every(({ result: ke, status: je }) => ke === 'ADDED' && je !== 'ACCEPTED'),
          S = !E && g?.result === 'ADDED' && g?.status !== 'ACCEPTED',
          L = !E && v?.result === 'ADDED' && g?.result !== 'ADDED' && g?.status !== 'ACCEPTED'
        J(() => {
          ;((y.current !== o ||
        ...
        if (t || !h.length)
          return a.createElement(
            os,
            { hidden: l },
            a.createElement(ss, null, a.createElement(ls, null, F)),
        ...
        return a.createElement(
          ...
          a.createElement(
            ss,
            null,
            a.createElement(ls, null, F, a.createElement(r6, { isOutdated: e }))
          ),
          a.createElement(
            rf,
            null,
            ...
            !te &&
              ...
              a.createElement(Y7, {
                ...
                latestImage: v.headCapture?.captureImage ?? void 0,
                baselineImage: v.baseCapture?.captureImage ?? void 0,
            ...
            !te &&
              ...
              a.createElement(
                a.Fragment,
                null,
                a.createElement(lf, null, a.createElement('b', null, 'Error stack trace')),
                a.createElement(of, null, fe.stack || fe.message)
              )
          ),
          a.createElement(ds, null, a.createElement(es, null))
        )
    ...
    var df = ({
        ...
        let { isRunning: o, startBuild: s, stopBuild: d } = Na(),
          {
            lastBuildOnBranch: c,
              ...
              r && L
                ? a.createElement(
                    ...
                    a.createElement(
                      'div',
                      null,
                      a.createElement(de, null, 'Snapshotting new story'),
                      a.createElement(
                        q,
                        { center: !0, muted: !0 },
                    ...
                    a.createElement(Yr, { localBuildProgress: r })
                  )
                : a.createElement(
                    oe,
                    null,
                    a.createElement(
                      'div',
                      null,
                      a.createElement(de, null, 'New story found'),
                      a.createElement(
                        q,
                        { center: !0, muted: !0 },
            ...
            a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  'div',
                  null,
                  a.createElement(de, null, 'This story was skipped'),
                  a.createElement(
                    q,
                    { center: !0, muted: !0 },
        ...
        let { status: F } = p,
          G = ['ANNOUNCED', 'PUBLISHED', 'PREPARED'].includes(F),
          te = F === 'FAILED',
          fe = F === 'PENDING' && (!y || !h)
        return a.createElement(
          he,
      ...
      cf = ({
        ...
        let { setAccessToken: o } = gl(),
          { isRunning: s, startBuild: d } = Na(),
          { disable: c, disableSnapshot: m, docsOnly: u } = Ql('chromatic', {}),
          p = () => {
            ...
            return i
              ? i.currentStep === 'error'
                ? a.createElement(
                    a.Fragment,
                    null,
                    a.createElement(cd, { localBuildProgress: i, title: 'Build failed' }),
                    f
                  )
            ...
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    'div',
                    null,
                    a.createElement(de, null, 'Network error'),
              ...
              ? a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      'div',
                      null,
                      a.createElement(de, null, e.graphQLErrors[0].message),
                      a.createElement(
                        q,
                        { center: !0, muted: !0 },
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        Ni,
                        { withArrow: !0, href: `${ws}#troubleshooting`, target: '_blank' },
                        'Troubleshoot'
                      )
                    )
                  )
                    ...
                    ? a.createElement(
                        ...
                        a.createElement(
                          ...
                          a.createElement(
                            'div',
                            null,
                            a.createElement(de, null, 'Visual tests disabled for this story'),
                            a.createElement(
                              q,
                              { center: !0, muted: !0 },
                              'Update ',
                      ...
                      : a.createElement(
                          ...
                          a.createElement(
                            ...
                            a.createElement(
                              'div',
                              null,
                              a.createElement(de, null, 'Create a test baseline'),
                              a.createElement(
                                q,
                                { center: !0, muted: !0 },
                                'Take an image snapshot of your stories to save their "last known good state" as test baselines.'
                  ...
                  : a.createElement(
                      ...
                      a.createElement(
                        ...
                        a.createElement(
                          'div',
                          null,
                          a.createElement(de, null, 'Project not found'),
                          a.createElement(
                            q,
                            { center: !0, muted: !0 },
      ...
      uf = ({ buildIsReviewable: e, userCanReview: t, onReviewSuccess: n, onReviewError: r }) => {
        let [{ fetching: i }, l] = p0(t7),
          ...
          s = z((c, m = 'SPEC') => o({ status: 'ACCEPTED', testId: c, batch: m }), [o]),
          d = z((c, m = 'SPEC') => o({ status: 'PENDING', testId: c, batch: m }), [o])
        return {
          isReviewing: i,
          acceptTest: s,
          unacceptTest: d,
...
`),
      pf = ({ lastBuildOnBranch: e, vtaOnboarding: t }) => {
        let n = Nt(),
          ...
          [l, o] = a.useState(!1),
          s = a.useCallback(() => {
            ;(o(!0), r.forEach(({ id: g }) => n.clearNotification(g)))
          }, [n, r]),
          [d, c] = a.useState(!1),
          m = a.useCallback(() => c(!0), []),
          [u, p] = a.useState(!0)
        ...
        let [{ fetching: f }, h] = p0(mf),
          y = a.useCallback(
            async (g) => {
              ;(await h({ input: { vtaOnboarding: g ? 'COMPLETED' : 'DISMISSED' } }), p(!0), c(!1))
          ...
          w = a.useMemo(
            () =>
              (
                ...
                (g) => g?.status === 'PENDING' && g?.result === 'CHANGED' && g?.story?.storyId === i
              ),
            [e, i]
          ),
          b = !l && !u && !d
      ...
      hf = ({
        ...
        let d = Nt(),
          ...
          p = n7({ projectId: l, storyId: s, gitInfo: o, selectedBuildInfo: e }),
          {
            account: f,
            features: h,
            manageUrl: y,
            ...
            onReviewError: (on, Md) => {
              on instanceof Error &&
                c({
                  ...
                  content: {
                    headline: `Failed to ${Md.status === 'ACCEPTED' ? 'accept' : 'unaccept'} changes`,
          ...
          je =
            v && 'testsForStatus' in v && v.testsForStatus?.nodes && bn(od, v.testsForStatus.nodes),
          Ae = S ? wp(je || []) : []
        ;(J(() => {
          i(Ae)
        }, [JSON.stringify(Ae), i]),
        ...
        let ye = z(() => v?.id && S && t({ buildId: v.id, storyId: s }), [t, S, v?.id, s]),
          {
            showOnboarding: Le,
            showGuidedTour: Vt,
              ...
              : a.createElement(
                  ...
                  !L || !g || !w || F
                    ? a.createElement(cf, {
                        ...
                        dismissBuildError: n,
                        localBuildProgress: r,
                        ...(S && { switchToLastBuildOnBranch: ye }),
                      })
                    : a.createElement(
                        $7,
                        { watchState: ke },
      ...
      ff = (e) => {
        ...
        return a.createElement(hf, { selectedBuildInfo: t, setSelectedBuildInfo: n, ...e })
      },
          ...
          m = kt(
            () =>
              zi(
                'startBuild',
                () => {
                  ;(s(!1), l(!0), n(Zc, { accessToken: t }), r?.({ action: 'startBuild' }))
                },
                1e3,
                !1
              ),
          ...
          u = kt(
            () =>
              zi(
                'startBuild',
                () => {
                  d ? (l(!1), n(Rc), r?.({ action: 'stopBuild' })) : s(!0)
                },
                1e3,
                !1
              ),
      ...
      gf = () => {
        let e = $n({
          [qc]: (t) => {
            ...
            if (n)
              if ((hn.delete(t.requestId), 'error' in t)) n.reject(new Error(t.error))
              else {
        ...
        return async (t, { signal: n, ...r } = {}) => {
          ...
          return (
            n?.addEventListener('abort', () => {
              ;(e($c, { requestId: i }), hn.get(i)?.reject(n.reason), hn.delete(i))
            }),
            e(Wc, { requestId: i, input: t, init: r }),
            new Promise((l, o) => {
              ;(hn.set(i, { resolve: l, reject: o }),
                setTimeout(() => {
                  ;(o(new Error('Request timed out')), hn.delete(i))
                }, 3e4))
            })
          )
        }
      ...
      Cd = () => {
        ...
        return {
          ...
          projectId: n,
          configFile: l,
          updateProject: z((o) => t({ ...e, projectId: o, dismissed: !1 }), [e, t]),
          projectUpdatingFailed: !i && r === !1,
          projectIdUpdated: !i && r === !0,
          clearProjectIdUpdated: z(() => t({ ...e, dismissed: !0 }), [e, t]),
        }
      },
      cs = Pa(j),
      vf = ({ active: e }) => {
        ...
        let h = z((ze) => {
          ...
          Vt = gf(),
          Ke = globalThis.LOGLEVEL === 'debug' ? globalThis.fetch : Vt,
          _e = (ze) =>
            a.createElement(
              V4,
              { value: y0({ fetch: Ke }) },
              a.createElement(
                ...
                a.createElement(
                  Jc,
                  { value: { accessToken: n, setAccessToken: l, subdomain: fe, setSubdomain: ke } },
                  a.createElement(
                    Z2,
                    { addonUninstalled: G, setAddonUninstalled: te },
                    a.createElement(
                      em,
                      null,
                      a.createElement(
                        Ep,
                        { watchState: { isRunning: Ae, startBuild: ye, stopBuild: Le } },
                        a.createElement(
                          'div',
        ...
        if (!e) return _e(null)
        if (globalThis.CONFIG_TYPE !== 'DEVELOPMENT') return _e(a.createElement(vp, null))
        if (G) return _e(a.createElement(bp, null))
        if (m) return _e(a.createElement(yp, { offline: m }))
        if (!n)
          return _e(
            a.createElement(J4, { setAccessToken: l, setCreatedProjectId: F, hasProjectId: !!w })
          )
        if (c || !d) return _e(a.createElement(np, { gitInfoError: c }))
        if (y) return e ? a.createElement(Bi, null) : null
        if (!w)
          return _e(
            a.createElement(pp, { createdProjectId: L, setCreatedProjectId: F, onUpdateProject: g })
          )
        if (v) {
          if (!b) throw new Error('Missing config file after configuration failure')
          return _e(a.createElement(cp, { projectId: w, configFile: b }))
        }
        if (E) {
          if (!b) throw new Error('Missing config file after configuration success')
          return _e(a.createElement(lp, { projectId: w, configFile: b, goToNext: S }))
        }
        let Jr = d.branch === u?.branch
        return _e(
          a.createElement(ff, {
            dismissBuildError: () => p(void 0),
            localBuildProgress: Jr ? u : void 0,
            updateBuildStatus: h,
            projectId: w,
            gitInfo: d,
            storyId: s,
      ...
      yf = { screen: { status: 'welcome' }, shareRequestId: null, shareTriggeredId: null }
    function bf(e, t, n, r) {
      if (
        (t.shareRequestId !== e.shareRequestId &&
          ...
          (t.status === 'pending' || t.status === 'uploading'
            ? (e = {
                ...
                screen: {
                  status: 'uploading',
                  shareUrl: t.status === 'uploading' ? (t.shareUrl ?? '') : '',
                },
              })
            : t.status === 'complete' &&
              t.shareUrl !== r &&
              (e = { ...e, shareRequestId: t.shareRequestId, shareTriggeredId: t.shareRequestId })),
        t.shareRequestId !== e.shareRequestId)
      )
      ...
      if (
        ...
        return {
          next: { ...e, screen: { status: 'uploading', shareUrl: t.shareUrl } },
      ...
      if (t.status === 'complete') {
        ...
        return {
          next: {
            ...e,
            screen: { status: 'complete', shareUrl: i, publishedAt: Date.now(), daysToExpire: l },
            shareRequestId: null,
            shareTriggeredId: null,
          },
          effect: { kind: 'completed', shareUrl: i, gitInfo: n, isNew: i !== r },
        }
      }
        ...
        ? t.canceled
          ...
          : /\b(401|403|unauthorized|expired)\b/i.test(t.error)
            ...
            : {
                next: {
                  ...e,
                  screen: { status: 'error', reason: 'unknown', message: t.error || void 0 },
                  shareRequestId: null,
                  shareTriggeredId: null,
                },
                effect: { kind: 'failed' },
    ...
    function Ef(e, t) {
      switch (t.type) {
        ...
        case 'START_SHARE_EMITTED':
          return { ...e, shareRequestId: t.id, shareTriggeredId: t.id }
        case 'APPLY_STATE':
          return t.next
        default:
          return e
    ...
    var Hn = k.div({
        ...
        return a.createElement(
          ...
          e &&
            a.createElement(
              io,
              {
                tooltip: a.createElement(ro, { note: r ? 'Copied!' : 'Copy link to clipboard' }),
                placement: 'top',
                visible: r || void 0,
              },
              a.createElement(
                ...
                r ? a.createElement(Zr, { color: 'green' }) : a.createElement(cc, null)
              )
            ),
          a.createElement(wf, { 'aria-live': 'polite' }, r ? 'Copied to clipboard' : '')
        )
      },
      xf = k.div({ display: 'flex', flexDirection: 'column', alignSelf: 'stretch', gap: 8 }),
      Af = k.div({
        display: 'flex',
        flexDirection: 'row',
        gap: 8,
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              'Learn more',
              a.createElement(Fc, { size: 14, 'aria-hidden': 'true' })
            )
          )
        )
      },
      Nf = k.div({ display: 'flex', flexDirection: 'row', gap: 6, alignItems: 'center' }),
      Mf = k.span(({ theme: e }) => ({
        fontSize: e.typography.size.s1,
        color: e.color.defaultText,
        lineHeight: '16px',
      ...
      Tf = k.div({ display: 'flex', flexDirection: 'row', gap: 6, alignItems: 'center' }),
      _f = k.span(({ theme: e }) => ({
        fontSize: e.typography.size.s1,
        color: e.color.defaultText,
        lineHeight: '16px',
        ...
        return (
          ...
          a.createElement(
            ...
            a.createElement(
              jn,
              null,
              a.createElement(ln, null, 'Copy link to published Storybook'),
              a.createElement(
                Dn,
                null,
            ...
            a.createElement(
              ...
              !r && o
                ? a.createElement(
                    Nf,
                    null,
                    a.createElement('span', null, '\u{1F389}'),
                    a.createElement(Mf, null, 'Storybook published!')
                  )
                : a.createElement(
                    Tf,
                    null,
                    a.createElement('span', { style: { fontSize: 12, flexShrink: 0 } }, '\u23F3'),
                    a.createElement(
                      _f,
                      null,
                      'Published ',
                      ...
                      n !== void 0
                        ? (() => {
                            let d = s6(t, n).getTime() - Date.now(),
                              c = Math.max(0, Math.ceil(d / 864e5))
              ...
              r &&
                a.createElement(
                  ...
                  a.createElement(re, { size: 'medium', variant: 'solid', onClick: i }, 'Republish')
                )
            ),
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              Bf,
              null,
              a.createElement(Pf, { status: 'critical' }, 'Error'),
              a.createElement(
                Vf,
                null,
                a.createElement('strong', null, 'Publish failed', r && ':'),
                ' ',
                r
              )
            )
      ...
      jf = ({ onSignIn: e, onSignInWithSSO: t }) =>
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(Sd, { onClick: t }, 'Connect with SAML SSO')
          ),
          a.createElement(zn, null)
        ),
      zf = k.form({ display: 'flex', flexDirection: 'column', alignSelf: 'stretch' }),
      Uf = k.div({
        display: 'flex',
        flexDirection: 'row',
        alignItems: 'center',
      ...
      qf = ({ onSubmit: e, onBack: t }) => {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(hs, { size: 12, 'aria-hidden': 'true' }),
            'Back'
          ),
          a.createElement(
            jn,
            ...
            a.createElement(Dn, null, "Enter your team's Chromatic subdomain.")
          ),
          a.createElement(
            zf,
            { onSubmit: s },
            a.createElement(
              ...
              a.createElement(
                re,
                { size: 'medium', variant: 'solid', type: 'submit', style: { flexShrink: 0 } },
                'Connect'
              )
            )
          ),
      ...
      Yf = ({ shareUrl: e, step: t = 'pending', onCopy: n, onCancel: r }) => {
        let i = r && t !== 'complete'
        return a.createElement(
          Hn,
          null,
          ...
          a.createElement(
            ...
            a.createElement(
              xd,
              { 'aria-live': 'polite' },
              a.createElement(hc, { size: 12, 'aria-hidden': 'true' }),
              Gf[t]
            ),
            i &&
              a.createElement(
                Sd,
                { type: 'button', 'aria-label': 'Cancel publish', onClick: r },
                'Cancel'
              )
          ),
          a.createElement(zn, null)
    ...
    function Qf({
      ...
      let m = me(!1),
        ...
        f = z(
          (L, F) => {
            e.getChannel()?.emit(Es, { action: L, entryPoint: 'toolbar', ...F })
          },
          [e]
        ),
      ...
      J(() => {
        ...
        t && L && !h && c({ type: 'AUTO_SKIP_TO_UPLOADING', newRequestId: crypto.randomUUID() })
      ...
      ;(J(() => {
        ...
        ;(c({ type: 'START_SHARE_EMITTED', id: L }),
          e.getChannel()?.emit(Bc, { accessToken: t, shareRequestId: L }),
          f('share-initiated', { isRepeatShare: m.current }),
          (m.current = !1))
      }, [e, c, f, y, w, b, r, h, t]),
        J(() => {
          ;(u.current === 'idle' && n.screen.status === 'uploading' && f('share-auth-completed'),
      ...
      ;((g.current = {
        ...
        J(() => {
          if (!r) return
          let L = g.current,
            { next: F, effect: G } = bf(L.reducerState, r, L.gitInfo, L.lastCompletedShareUrl)
          switch ((F !== L.reducerState && L.dispatch({ type: 'APPLY_STATE', next: F }), G.kind)) {
            case 'url-received':
            ...
            case 'auth-error':
              p.current
                ? ((p.current = !1), L.updateToken(null), L.emitTelemetry('share-failed'))
                : ((p.current = !0),
      ...
      let v = z(() => {
          ;(e.getChannel()?.emit(Pc, { shareRequestId: n.shareRequestId }), f('share-canceled'))
        }, [e, f, n.shareRequestId]),
        E = z(() => {
          ;((p.current = !1),
            c({ type: 'PUBLISH_REQUESTED', hasToken: !!t, newRequestId: crypto.randomUUID() }))
        }, [c, t]),
        S = z(() => {
          ;((m.current = !0), c({ type: 'PUBLISH_AGAIN', newRequestId: crypto.randomUUID() }))
        }, [c])
      return { emitTelemetry: f, handleCancel: v, handlePublish: E, handlePublishAgain: S }
    }
    var ol = !1,
      Xf = () => ol,
      e8 = ({ api: e }) => {
        ...
        let p = z((E) => s({ type: 'SET_SCREEN', screen: E }), []),
          { startSignIn: f, updateToken: h } = Jf(p),
          {
            emitTelemetry: y,
            handleCancel: w,
            handlePublish: b,
        ...
        switch (v.status) {
          ...
          case 'error':
            return a.createElement(Df, { reason: v.reason, message: v.message, onRetry: b })
          default:
            return null
        }
      },
      t8 = ({ api: e }) =>
        a.createElement(
          ...
          a.createElement(
            jt,
            { variant: 'ghost', padding: 'small', id: 'chromatic-share-button' },
            'Share'
          )
        ),
      Mi = bt(dl()),
      n8 = k.div({ display: 'flex', justifyContent: 'space-between', padding: '8px 0' }),
      a8 = k.div({ display: 'flex', flexDirection: 'column', marginLeft: 8 }),
      ...
      l8 = k.div(({ theme: e }) => ({ fontSize: e.typography.size.s1, color: e.textMutedColor })),
      o8 = k(no)({ margin: 4 }),
      s8 = k(lc)({ width: 10 }),
      d8 = () => {
        let { addNotification: e, selectStory: t, setOptions: n, togglePanel: r } = Nt(),
          i = Gl(
            (ye) =>
              Object.values(ye)
                .map((Le) => Le[j]?.value)
                .filter((Le) => Le === 'status-value:warning').length
          ),
          l = sn(Br),
          { projectId: o } = Cd(),
          [s] = zr(),
          ...
          E = Yl((ye) => ye[Ti] ?? 'test-provider-state:pending'),
          { startBuild: S, stopBuild: L } = wd({ localBuildProgress: u, accessToken: s }),
          F
        ;(c && (F = 'Not available offline'),
          f && (F = 'Configuration problem'),
          y && (F = 'Git synchronization problem'),
          d || (F = 'Login required'),
          o || (F = 'Set up visual tests'))
        let G = !F && E !== 'test-provider-state:crashed',
          te = z(() => {
            G && S()
          }, [G, S])
        J(() => ql(Ti).onRunAll(te), [te])
        let fe = z(
            (ye) => {
              if ((n({ selectedPanel: En }), r(!0), b && v !== 'story')) {
                let Le = Object.keys(b).indexOf(g),
                  Vt = Object.entries(b).slice(Le > 0 ? Le : 0),
                  [Ke] = Vt.find(([, { type: _e }]) => _e === 'story') || []
                Ke && t(Ke)
              }
        ...
        ;(J(() => {
          ...
          return (
            ...
            () => {
              ;(window.removeEventListener('offline', ye), window.removeEventListener('online', Le))
            }
          )
        }, [m]),
          J(() => {
        ...
        switch (!0) {
          case !!F:
            Ae = a.createElement(zt, { onClick: je }, F)
            break
          case E === 'test-provider-state:running':
            Ae = u ? Wl[u.currentStep].renderProgress(u) : 'Starting...'
            break
          case Zl(u, h):
          ...
          case u?.currentStep === 'complete':
            Ae = u.errorCount
              ? `Encountered ${(0, Mi.default)('component error', u.errorCount, !0)}`
              : i
                ? `Found ${(0, Mi.default)('story', i, !0)} with ${(0, Mi.default)('change', i)}`
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              u?.currentStep === 'error' || u?.currentStep === 'limited'
              ...
              : E === 'test-provider-state:running'
                ? a.createElement(
                    jt,
                    {
                      ...
                      padding: 'none',
                      onClick: L,
                      disabled: !['initialize', 'build', 'upload'].includes(u?.currentStep ?? ''),
                    },
                    a.createElement(
                      o8,
                      { percentage: u?.buildProgressPercentage },
    ...
    if (window.opener && !window.opener.closed) {
      let e = new URLSearchParams(window.location.search),
        ...
        r = e.get('error')
      if (t && n)
        (window.opener.postMessage({ message: 'grant', code: t, state: n }, window.location.origin),
          window.close())
      else if (r && n) {
        let i = e.get('error_description')
        ;(window.opener.postMessage(
          { message: 'grant', error: r, state: n, ...(i ? { error_description: i } : {}) },
    ...
    dn.register(j, (e) => {
      ;(e.on(zc, (r, i) => {
        ...
        dn.add(En, {
          ...
          paramKey: Dc,
          match: ({ viewMode: r }) => r === 'story',
          render: ({ active: r }) => a.createElement(vf, { active: !!r }),
        }))
      let t = e.getChannel()
      if (t) {
        let r = null
        Sl.subscribe(fl, t).on('change', (i) => {
          if (i?.status !== 'complete' || i.shareUrl === r || Xf()) return
          let { shareUrl: l } = i
          ;((r = l),
            e.addNotification({
              id: `${j}/share-published`,
              content: { headline: 'Storybook published!', subHeadline: l },
              duration: 8e3,
              onClick: ({ onDismiss: o }) => {
                ;(navigator.clipboard.writeText(l).catch(() => {}), o())
              },
            }))
        })
      }
