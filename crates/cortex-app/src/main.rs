...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::load_collection_environments,
            commands::update_collection_environment_variables,
            commands::delete_collection_environment,
            commands::rename_collection_environment,
